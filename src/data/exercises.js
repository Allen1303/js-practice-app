...
console.log(typeof age); // "number"`,
    exercises: [
      {
        ...
        conceptContext: "Modern JavaScript uses `const` for values that never change and `let` for values that can change. Never use `var` in modern code because it lacks safety walls.",
        description: "Let's learn how to declare a variable! Declare a constant variable named `multiplier` and set it to `10`. Then, return the input parameter `x` multiplied by modern `multiplier`.",
  ...
  // Declare 'multiplier' with const and multiply x by it
        ...
        explanation: "Simple variable assignment using const guarantees the reference does not get rewritten.",
        testCases: [
          { id: 1, input: [5], expected: 50, description: "5 multiplied by 10 is 50" },
          { id: 2, input: [0], expected: 0, description: "0 multiplied by 10 is 0" }
        ]
      },
      {
        id: "number-addition",
        ...
        conceptContext: "Use the plus `+` operator to perform arithmetic addition in JavaScript.",
        description: "Write a function `sumTwo(a, b)` that adds the two parameter numbers `a` and `b` together and returns the sum.",
  ...
  // Add values a and b, and return the result
        ...
        testCases: [
          { id: 1, input: [10, 5], expected: 15, description: "10 and 5 is 15" },
      ...
      },
      {
        ...
        conceptContext: "The remainder `%` operator (often called modulo) computes the leftover from dividing two numbers. Check odd parity with `num % 2 !== 0`.",
        description: "Write a function `isOdd(num)` that returns `true` if the input number `num` is an odd number, and `false` if it is even.",
  ...
  // Use remainder % 2 check to find odd numbers
        ...
        explanation: "Remainder operators division checking is standard for checking numerical parity.",
        testCases: [
          { id: 1, input: [7], expected: true, description: "7 is an odd number" },
          { id: 2, input: [12], expected: false, description: "12 is an even number" },
          { id: 3, input: [-5], expected: true, description: "Handles negative odd integers safely" }
        ]
      },
      {
        id: "num-parse",
        ...
        conceptContext: "In web layouts, CSS dimensions exist as strings like `'24px'`. Use `Number.parseInt(text, 10)` to extract the pure numerical integer, using radix base 10.",
        description: "Write a function `extractPixels(cssValue)` that parses and returns the raw numerical integer from a CSS dimension string (e.g. `'30px'`).",
  ...
  // Extract number from css string (e.g. "24px" -> 24)
        ...
        explanation: "Number.parseInt looks at strings left-to-right, discarding trailing non-numeric values seamlessly.",
        testCases: [
          { id: 1, input: ["24px"], expected: 24, description: "Extracts 24 from 24px string" },
          { id: 2, input: ["1080p"], expected: 1080, description: "Handles other trailing characters smoothly" }
        ]
      },
      {
        id: "number-typeof",
        ...
        conceptContext: "The `typeof` operator inspects what primitive category you are working with, returning string indicators such as `'number'`, `'string'`, or `'boolean'.`",
        description: "Write a function `inspectType(value)` that takes any input and returns its typeof string description (like `'number'` or `'string'`).",
  ...
  // Return the typeof value
        ...
        explanation: "Evaluating runtime variable types checks memory invariants beautifully.",
        testCases: [
          { id: 1, input: [42], expected: "number", description: "42 is a number" },
          { id: 2, input: ["learnjs"], expected: "string", description: "learnjs is a string" },
          { id: 3, input: [true], expected: "boolean", description: "true is a boolean" }
        ]
      }
    ]
  },
...
=======
    ...
    shortDescription: "Learn explicit vs implicit returns, and logical branch conditions.",
    longExplanation: "Functions take inputs (parameters), do some calculations, and return a final value. Conditions like `if` and `else` let your application execute different directions of code depending on calculations.\n\n- **Explicit Return**: Always write the word `return` inside a standard function body. If you omit it, the function returns `undefined`!\n- **Strict Equality**: Always use `===` instead of `==`. The triple-equals verifies that both values are identical in value *and* data type.\n- **Truthy/Falsy**: Values like `0`, `\"\"`, `null`, `undefined`, and `false` are naturally falsy. Almost everything else evaluates to truthy.",
...
>>>>>>> 3a38aa8dc381a120e566a2905122330ec134c073
}
...
console.log(double(10));           // 20`,
    exercises: [
      {
        ...
        conceptContext: "Unlike console.log() which just makes words appear in terminal logs, the `return` statement stops function execution and hands the calculated result back to your application.",
        description: "Write a function `doubleValue(num)` that doubles the input variable `num` and explicitly returns the computed calculation.",
  ...
  // Be sure to explicitly use the 'return' keyword!
        ...
        explanation: "Explicit returns stop local loops and yield physical memory storage values.",
        testCases: [
...
switch (command) {
    ...
    exercises: [
      {
        ...
        conceptContext: "Use an `if` block to run code when a condition is true, and an `else` block to handle all other fallback conditions.",
        description: "Write a function `getAgeGreeting(age)` that takes an age number and returns the string `'Adult'` if the age is `18` or greater, and `'Minor'` if the age is less than `18`.",
  ...
  // Use if and else statements to test if age is >= 18
        ...
        explanation: "Simple logical switches guide basic navigation state filters cleanly.",
        testCases: [
          { id: 1, input: [20], expected: "Adult", description: "20 is an adult" },
          { id: 2, input: [15], expected: "Minor", description: "15 is a minor" },
          { id: 3, input: [18], expected: "Adult", description: "Boundary check for age 18" }
        ]
      },
      {
        id: "cond-strict",
        ...
        conceptContext: "Always favor strict equality `===` (triple-equals) inside modern programs. The weak matcher `==` auto-converts types behind your back (e.g., `'5' == 5` is true), which causes hidden, nasty bugs.",
        description: "Write a function `isIdentical(a, b)` that returns `true` if parameters `a` and `b` are exactly equal both in value and type using modern strict identity.",
  ...
  // Compare values using strict triple equality
        ...
        explanation: "Strict identity === avoids browser type-coercion bypass vulnerabilities.",
        testCases: [
<<<<<<< HEAD
          {
            id: 1,
...
=======
          { id: 1, input: ["hello", "hello"], expected: true, description: "Identical strings match" },
          { id: 2, input: ["5", 5], expected: false, description: "Prevents string and integer false equivalence matches" }
        ]
      }
    ]
>>>>>>> 3a38aa8dc381a120e566a2905122330ec134c073
...
console.log(label.toLowerCase()); // "vite app"`,
    exercises: [
      {
        ...
        conceptContext: "The `.length` property of a string counts every individual character in a string, including empty spacing boundaries and formatting characters.",
        description: "Write a function `getStringLength(text)` that returns the total character count of the input parameter `text` string.",
  ...
  // Return the string length count
        ...
        explanation: "Monitoring input lengths ensures user names fit within profile database bounds.",
        testCases: [
          { id: 1, input: ["JavaScript"], expected: 10, description: "JavaScript has 10 characters" },
          { id: 2, input: ["hello world"], expected: 11, description: "Space boundaries are included in the length counts" }
        ]
      },
      {
        id: "str-index-char",
        ...
        conceptContext: "JavaScript strings are indexed starting from position zero `0`. To find the first letter of any text, query `text[0]`.",
        description: "Write a function `getFirstChar(text)` that takes a string and returns the first character from the string. Return `null` if the string is empty.",
  ...
  // Return the very first character of the text, or null if the string is empty
        ...
        explanation: "Querying index numbers allows reading elements from primitive strings immediately.",
        testCases: [
          { id: 1, input: ["Vite"], expected: "V", description: "First character of Vite is V" },
          { id: 2, input: ["a"], expected: "a", description: "Handles single characters perfectly" },
          { id: 3, input: [""], expected: null, description: "Correctly handles empty parameter values" }
        ]
      }
    ]
  },
  {
    ...
    shortDescription: "Master side-effects, manual accumulation, and array scanning via .forEach() loops.",
    longExplanation: "The `.forEach()` method executes a provided callback function once for each array element. Unlike `.map()` or `.filter()`, it returns `undefined` and is used strictly to execute side-effects, such as mutating outer variables, logging info, or updating database collections.\n\n- **No New Array**: `.forEach()` does not generate or return a new list. It operates on the existing data or triggers outside actions.\n- **Parameters**: The callback receives the standard (element, index, originalArray) trio.",
...
console.log(sum); // 60`,
    exercises: [
      {
        ...
        conceptContext: "While standard for-loops scan indices, `.forEach()` cleanly feeds element values directly into external tracker variables sequentially.",
        description: "Let's master basic side effects! Write a function `accumulateSum(nums)` that initializes a running sum variable at 0. Use `.forEach()` to iterate over `nums` and add each number to the running sum, then return the final sum.",
  ...
  return sum;
        ...
        explanation: "Manual state aggregation using local tracker variables is a robust pattern for custom list calculations.",
        testCases: [
          { id: 1, input: [[2, 4, 6]], expected: 12, description: "Sums standard positives correctly" },
          { id: 2, input: [[]], expected: 0, description: "Handles empty array elements" }
        ]
      },
      {
        id: "foreach-average",
        ...
        conceptContext: "Building on manual sums, we can find average sizes by accumulating sum and checking lengths directly.",
        description: "Write a function `calculateAverage(nums)` that finds the numerical average of `nums` using `.forEach()`. If the array is empty, return `0` directly.",
  ...
  // Use .forEach() to find sum, then divide by elements length
        ...
        explanation: "Combining counts with aggregated sums compiles simple average stats smoothly.",
        testCases: [
          { id: 1, input: [[10, 20, 30]], expected: 20, description: "Computes positive numbers average cleanly" },
          { id: 2, input: [[]], expected: 0, description: "An empty array returns 0 safely" }
        ]
      },
      {
        ...
        difficulty: "Warm-up",
        codeSnippet: `let log = "";\n["A", "B"].forEach((char, i) => {\n  log += (i > 0 ? ", " : "") + char;\n}); // "A, B"`,
        conceptContext: "Dynamic string assembly utilizing active index locations lets you form custom comma-separated log structures on top of lists.",
        description: "Write a function `buildLogString(events)` that loops over an array of event strings using `.forEach()`. It should return a single concatenated string where each event is separated by `' | '`. If the array is empty, return an empty string `\"\"`.",
  ...
  return result;
        ...
        explanation: "Index checking avoids trailing delimiters in custom text files and log streams.",
        testCases: [
          { id: 1, input: [["Login", "Click", "Logout"]], expected: "Login | Click | Logout", description: "Accurately connects list items using custom pipes" },
          { id: 2, input: [[]], expected: "", description: "Returns empty string for empty input data lists" }
        ]
      },
      {
        ...
        conceptContext: "Because javascript copies object references, mutating properties inside a `.forEach()` iteration modifies the original objects directly.",
        description: "In full-stack architectures, updating object arrays with identifiers ensures relational integrity. Write a function `registerInboundUsers(users, baseID)` that iterates through an array of user objects and assigns each object an `accountID` property computed as `baseID + index`.",
  ...
  return users;
        ...
        explanation: "Reference mutations directly inside lists enrich active row variables in-place without copying overhead.",
        testCases: [
          { id: 1, input: [[{ name: "Alice" }, { name: "Bob" }], 1000], expected: [{ name: "Alice", accountID: 1000 }, { name: "Bob", accountID: 1001 }], description: "Assigns incremental IDs from a base integer offset" }
        ]
      },
      {
        id: "foreach-classify",
        ...
        conceptContext: "Pushing elements into completely separate external arrays compiles multi-bucket categories without modifying the original database arrays.",
        description: "Let's perform a bulk classification. Write a function `classifyScores(scores, threshold)` that splits a flat list of test scores into two separate arrays inside a return object: `passed` (scores >= threshold) and `failed` (scores < threshold). Return the resulting classification object.",
  ...
  return { passed, failed };
        ...
        explanation: "Multi-destination pushing sorts raw arrays into multi-bucket categories highly productively.",
        testCases: [
          { id: 1, input: [[85, 45, 90, 60], 70], expected: { passed: [85, 90], failed: [45, 60] }, description: "Dispatches scores into success and failure buckets cleanly" }
        ]
      },
      {
        ...
        conceptContext: "Initializing missing keys to zero before incrementing counts compiles frequency profiles or lookup map directories.",
        description: "Write a function `buildFrequencyTally(items)` that returns an object tallying frequency counts. Use `.forEach()` to record how many times each string item appears in the array.",
  ...
  return tally;
        ...
        explanation: "Frequency dictionaries are standard for ranking search keywords and word statistics.",
        testCases: [
          { id: 1, input: [["apple", "banana", "apple"]], expected: { apple: 2, banana: 1 }, description: "Tallies repeated word strings accurately" },
          { id: 2, input: [[]], expected: {}, description: "Yields empty object for empty parameters" }
        ]
      },
      {
        ...
        conceptContext: "Since the callback provides the original array reference, we can mutate or replace values at targeted locations directly inside the loop.",
        description: "Write a function `scaleEvenIndices(nums)` that takes an array of numbers and multiplies each element located at **even index positions** (0, 2, 4...) by `10`. Return the original modified array.",
  ...
  return nums;
        ...
        explanation: "In-place modifications of arrays using indexing maps sequences efficiently without auxiliary allocations.",
        testCases: [
          { id: 1, input: [[1, 2, 3, 4, 5]], expected: [10, 2, 30, 4, 50], description: "Scales indices 0, 2, and 4 in-place cleanly" }
        ]
      },
      {
        ...
        conceptContext: "Frontend state hydration relies on scanning nodes to configure custom stylesheet or configuration options before drawing them.",
        description: "Let's simulate standard browser UI setup. Write a function `hydrateDOMNodes(nodes, globalTheme)` that processes a list of mock DOM nodes `{ tag, classes: [] }`. It should append `globalTheme` into each node's `classes` array, and if the node represents a `'button'`, also add an `'btn-active'` class. Return the updated array.",
  ...
  return nodes;
        ...
        explanation: "Mocking node setups before writing UI components is practical in SPA component designs.",
        testCases: [
          { id: 1, input: [[{ tag: "div", classes: ["flex"] }, { tag: "button", classes: [] }], "dark-mode"], expected: [{ tag: "div", classes: ["flex", "dark-mode"] }, { tag: "button", classes: ["dark-mode", "btn-active"] }], description: "Applies themes and specialized class conditions correctly" }
        ]
      },
      {
        ...
        conceptContext: "When dealing with multi-dimensional grids, nesting `.forEach()` handlers inside each other parses multi-level numbers perfectly.",
        description: "Write a function `sumMatrix(matrix)` that calculates the grand total of all numbers inside a 2D grid matrix of numbers using nested `.forEach()` loops.",
  ...
  return grandTotal;
        ...
        explanation: "Traversing grid arrays is straightforward when sequential inner-loop offsets execute row-by-row.",
        testCases: [
          { id: 1, input: [[[1, 2], [3], [4, 5]]], expected: 15, description: "Sums arbitrary dimensions correctly" }
        ]
      },
      {
        id: "foreach-pipeline",
        ...
        conceptContext: "A pipeline is an array of functions. Using `.forEach()` to iterate over functions and apply them to a single state builds customizable transformer engines.",
        description: "Create a data validation compiler! Write a function `runPipeline(input, steps)` that takes an initial input value and an array of helper transformer functions `steps`. Iterate over the functions and pipe the output of each function as the input to the next. Return the final transformed value.",
  ...
  return currentVal;
        ...
        explanation: "Function arrays act as dynamic middleware filters inside compilers and web routing architectures.",
        testCases: [
          { id: 1, input: [5, [x => x + 3, x => x * 2, x => x - 1]], expected: 15, description: "Executes pipeline step sequence in correct order" }
        ]
      }
    ]
  },
  {
    ...
    shortDescription: "Learn how to transform every item in an array to create a brand new list.",
    longExplanation: "The `.map()` method is like a machine that takes an array and runs a function on every item inside it, one by one. It then gives you a brand-new array with all the updated values.\n\n- **Never Changes the Original**: The original array stays exactly the same. You always get a clean, new list back.\n- **Optional Info**: Inside your function, you can optionally access not just the current item, but also its position index and the entire original array.",
...
// ["HELLO", "WORLD"]`,
  ...
  // Use .map() to return clean, standardized uppercase terms
        ...
        explanation: "Simple layout transformations using chainable standard string utility filters on map closures.",
        testCases: [
          { id: 1, input: [[" alpha ", "  beta  ", "gamma"]], expected: ["ALPHA", "BETA", "GAMMA"], description: "Standardized spacing and casing correctly" },
          { id: 2, input: [["test"]], expected: ["TEST"], description: "Simple single word check" }
        ]
      },
      {
        ...
        conceptContext: "To convert Fahrenheit temperatures to Celsius mathematically, use the formula: C = (F - 32) * 5/9. Running this calculation across arrays maps whole datasets instantly.",
        description: "You are working on a weather dashboard that aggregates temperature readings. Write a function `convertFToC(tempsF)` that maps an array of Fahrenheit temperatures into an array of equivalent Celsius temperatures. Round each resulting Celsius temperature to the nearest integer using Math.round().",
  ...
  // Use .map() to convert Fahrenheit to Celsius and round each reading
        ...
        explanation: "Temperature data normalization handles device variation before presenting metric visualizer grids.",
        testCases: [
          { id: 1, input: [[32, 68, 104]], expected: [0, 20, 40], description: "Standard atmospheric conversions are mathematically sound" },
          { id: 2, input: [[-40, 50]], expected: [-40, 10], description: "Handles sub-zero boundary points smoothly" }
        ]
      },
      {
        ...
        conceptContext: "Standardizing raw text records by appending fixed strings inside a mapping callback is common when formatting user details or system URLs.",
        description: "A school needs to generate corporate email addresses for new students. Write a function `generateEmails(usernames, domain)` that takes an array of usernames and a domain string (like 'school.edu'). It should return a new array where each username is appended with '@' and the domain name, all in lowercase.",
  ...
  // Use .map() and template literals to append the lowercase domain
        ...
        explanation: "Automating system record standardizations saves manual database update overhead.",
        testCases: [
          { id: 1, input: [["Alice", "BobSmith", "charlie"], "School.edu"], expected: ["alice@school.edu", "bobsmith@school.edu", "charlie@school.edu"], description: "Correctly builds standard educational email domains" }
        ]
      },
      {
        id: "map-word-lengths",
        ...
        conceptContext: "Splitting a sentence string into individual word tokens allows you to map structures like word sizes for text visualization and wrap bounds.",
        description: "Write a function `getWordLengths(sentence)` that takes a sentence string. It should split the sentence by spaces into words, and then map those words to return a new array containing the character length of each word. If the sentence is an empty string, return an empty array [].",
  ...
  // 3. Map word tokens to their corresponding lengths
        ...
        explanation: "Casing and size metrics feed into adaptive natural language parsers beautifully.",
        testCases: [
          { id: 1, input: ["Learn JavaScript code"], expected: [5, 10, 4], description: "Returns individual lengths for multi-word strings" },
          { id: 2, input: ["  "], expected: [0, 0, 0], description: "Handles space divisions seamlessly" },
          { id: 3, input: [""], expected: [], description: "Handles empty string boundaries" }
        ]
      },
      {
        id: "map-scale-parity",
...
// ["1: Alice", "2: Bob"]`,
        conceptContext: "The callback passed to `.map()` receives three arguments: the current element value, its index (zero-based position), and the original array.",
        description: "Now that you can map simple primitives, let's inject the optional element *index* parameters inside mapping callbacks!\n\nWrite a function `scaleByIndex(nums)` that transforms an array of integers utilizing this condition logic:\n- If the element value is **even**, return its value doubled (`val * 2`).\n- If the element value is **odd**, return its value multiplied by its current *element index* in the array (`val * index`).",
  ...
  // Use the optional index parameter in your callback: .map((val, index) => ...)
        ...
        explanation: "Callback mapping handles multi-variable contexts such as matching arrays to their physical positional index values.",
        testCases: [
          { id: 1, input: [[10, 3, 5, 2]], expected: [20, 3, 10, 4], description: "Check mixed even and odd values with indices" },
          { id: 2, input: [[1, 1, 1]], expected: [0, 1, 2], description: "Pure odd arrays scaled strictly by indices" }
        ]
      },
      {
        id: "map-html-tags",
  ...
  // Use map's element index parameter to return template-escaped list items
        ...
        explanation: "Dynamic frontend templates are hydrated directly using element array indices for reliable browser reconciliation.",
        testCases: [
          { id: 1, input: [["Home", "Dashboard", "Settings"]], expected: ["<li id=\"0\">Home</li>", "<li id=\"1\">Dashboard</li>", "<li id=\"2\">Settings</li>"], description: "Yields clean HTML tags synchronized with active indices" }
        ]
      },
      {
        ...
        conceptContext: "E-commerce lists contain multiple product records. Computing line-item totals (price * quantity) transforms object collections into simple transaction streams.",
        description: "For a shopping cart analytics service, write a function `computeItemTotals(items)` that takes an array of objects representing items in a cart: { name, price, quantity }.\n\nIt should return a new array containing the total price value computed for each cart item (price * quantity).",
  ...
  // Map our object array into a single simple array of numbers
        ...
        explanation: "Line-item computations are mapped prior to calculating global grand totals or tax rates.",
        testCases: [
          { id: 1, input: [[{ name: "Book", price: 15, quantity: 2 }, { name: "Pen", price: 2, quantity: 10 }]], expected: [30, 20], description: "Accurately computes line-item dollar totals" }
        ]
      },
      {
...
const profiles = members.map(m => ({ username: m.name, status: m.active ? "Online" : "Offline" }));`,
  ...
  // Map our list of profile objects to a clean simplified format
        ...
        explanation: "Filtering and reshaping complex key objects into simple payloads is a highly repeated practice in server requests.",
        testCases: [
          { id: 1, input: [[{ name: "Alice", birthYear: 1996 }, { name: "Bob", birthYear: 2002 }]], expected: [{ username: "Alice", age: 30 }, { username: "Bob", age: 24 }], description: "Computes ages correctly relative to year 2026" }
        ]
      },
      {
        id: "map-diff-bounds",
...
// [15, 0, 25]`,
        conceptContext: "To map arrays relative to their global structure, query global variables or helpers first. For instance, use spread parameters with math helpers to discover the largest number in a dataset.",
        description: "Sometimes, before performing `.map()`, you need to calculate some collective metrics on the array.\n\nWrite a function `peakNormalize(nums)` that finds the absolute maximum value (the highest peak) in `nums`, and then returns a new array where each element `x` is replaced by its absolute difference from that maximum value (`Math.abs(peak - x)`).",
  ...
  // 2. Use .map() to calculate the distance of each element from that peak
        ...
        explanation: "Array transformations are highly responsive when utilizing aggregated dataset characteristics like average or minimum/maximum bounds first.",
        testCases: [
          { id: 1, input: [[2, 10, 6]], expected: [8, 0, 4], description: "Calculates offsets based on maximum peak (10)" },
          { id: 2, input: [[-5, -10, -1]], expected: [4, 9, 0], description: "Verifies negative peaks function seamlessly" }
        ]
      },
      {
        id: "map-coordinates",
...
// [5, 21]`,
  ...
  // Map row/col details to direct linear storage offsets
        ...
        explanation: "In discrete graphics software and path searches, high speed multi-dimensional data stores are optimized by flattening layouts to linear indices.",
        testCases: [
          { id: 1, input: [[{ r: 0, c: 5 }, { r: 2, c: 1 }], 10], expected: [5, 21], description: "Computes 1D grid mappings accurately for width 10" },
          { id: 2, input: [[{ r: 1, c: 0 }], 4], expected: [4], description: "Computes single index bounds correctly" }
        ]
      }
    ]
  },
  {
    ...
    shortDescription: "Keep only the items in an array that match a specific condition or rule.",
    longExplanation: "The `.filter()` method lets you screen an array and pick out only the elements you want. It runs a test function on each item: if the item passes the test (returns `true`), it gets added to the new array. If not, it is left behind.\n\n- **Keeps the Original Safe**: Just like `.map()`, it won't change your original array. It just returns a fresh, smaller list.\n- **The True/False Rule**: Your helper function must return either `true` (to keep the item) or `false` (to throw it out).",
...
// [15, 0, 32]`,
  ...
  // Use .filter() to retain strictly non-negative numbers
        ...
        explanation: "Simple filter application verifying array elements against constant parameter bounds.",
        testCases: [
          { id: 1, input: [[-1, 0, 5, -8, 12]], expected: [0, 5, 12], description: "Prunes negative integers safely while retaining zero" }
        ]
      },
      {
        id: "filter-range",
        ...
        conceptContext: "Passing contextual state boundaries in filter comparison routines dynamically limits list outcomes.",
        description: "Write a function `filterRange(nums, min, max)` that filters the `nums` array to keep only numbers that are between the values of `min` and `max` (inclusive).",
  ...
  // Return only numbers nested within the inclusive [min, max] range
        ...
        explanation: "Inclusive interval constraints let you filter pricing ranges and paginated item scopes.",
        testCases: [
          { id: 1, input: [[5, 12, 18, 24, 30], 10, 25], expected: [12, 18, 24], description: "Keeps numbers lying within bounds correctly" }
        ]
      },
      {
        id: "filter-emails",
        ...
        conceptContext: "Validating inputs via multiple logical checks in filter callbacks helps sanitize raw form lists cleanly.",
        description: "Let's validate contact options! Write a function `filterEmails(emails)` that filters an array of email strings, keeping only valid email addresses. A valid email address MUST contain the character `'@'` AND end with either `'.com'` or `'.org'`. All other strings are skipped.",
  ...
  // Filter for strings containing '@' and ending with '.com' or '.org'
        ...
        explanation: "Filtering contact records is essential for keeping clean distribution databases.",
        testCases: [
          { id: 1, input: [["contact@company.com", "john.doe", "support@org.org"]], expected: ["contact@company.com", "support@org.org"], description: "Retains only formatted matching domain records" }
        ]
      },
      {
        ...
        conceptContext: "Subtracting sets using filter checks checks which elements are exclusive to particular collections.",
        description: "Write a function `filterExclusive(arr1, arr2)` that takes two separate arrays of numbers and returns a new list of elements that exist inside `arr1` but are **not** present in `arr2`. Use the array `.includes()` method.",
  ...
  // Filter elements of arr1 that are not present inside arr2
        ...
        explanation: "Computing set differences is a primary tool for comparing lists.",
        testCases: [
          { id: 1, input: [[1, 2, 3, 4], [3, 4, 5]], expected: [1, 2], description: "Retains only numbers exclusive to the first parameter array" }
        ]
      },
      {
        ...
        conceptContext: "Filtering an array of keys using external index lookups or tables is very common when synchronizing multiple caches.",
        description: "Write a function `filterRegistered(ids, activeDirectory)` that takes an array of primitive user IDs and a lookup object `activeDirectory` (where registered IDs are keys mapped to boolean values). Filter the list of IDs, keeping only those that are present in the `activeDirectory` and marked `true`.",
  ...
  // Use bracket notation to check existence inside activeDirectory
        ...
        explanation: "Using fast dictionary lookups validates membership in constant O(1) time.",
        testCases: [
          { id: 1, input: [[101, 102, 103], { 101: true, 103: false }], expected: [101], description: "Matches IDs registered with truthy directories successfully" }
        ]
      },
      {
        ...
        conceptContext: "Combining flat property flags matching nested array inspections creates sophisticated business rules inside filters.",
        description: "Write a function `filterHonors(students)` that takes an array of object models represent students: `{ name, active, grades }` (where `grades` is a number list). It should filter the array, keeping only students who are marked `active: true` **AND** have at least one grade in their list of grades that is strictly **greater than or equal to 90**.",
  ...
  // Filter students based on active flag and grade properties
        ...
        explanation: "Compound conditions inside filters isolate qualifying entities instantly.",
        testCases: [
          { id: 1, input: [[{ name: "Alice", active: true, grades: [85, 92] }, { name: "Bob", active: false, grades: [95] }, { name: "Charlie", active: true, grades: [70, 80] }]], expected: [{ name: "Alice", active: true, grades: [85, 92] }], description: "Filters matching active honors list students faithfully" }
        ]
      },
      {
        id: "filter-averages",
...
// [30]`,
        conceptContext: "Callbacks can use variables declared outside the `.filter()` block. Calculating metrics beforehand lets you filter relative to dynamic totals.",
        description: "Building on the basic filter, let's work on dynamic criteria derived from the array itself.\n\nWrite a function `filterAverages(nums)` that calculates the average value of `nums` first, and then filters the array to keep only elements that are strictly **greater** than that average.",
  ...
  // 2. Filter keeping only items strictly greater than the average value.
        ...
        explanation: "Using dynamic variables inside a filter comparison is typical for statistical outlier detection.",
        testCases: [
          { id: 1, input: [[10, 20, 30]], expected: [30], description: "Average is 20, keeps only elements strictly greater than 20" },
          { id: 2, input: [[5, 5, 5]], expected: [], description: "Handles arrays with no values above average" }
        ]
      },
      {
        id: "filter-uniques",
...
// [1, 3]`,
        conceptContext: "An element is unique in an array if its first occurrence index matches its last occurrence index, which can be queried using built-in array index helpers.",
        description: "Let's build on local searches to handle global-occurrence uniqueness filtering.\n\nWrite a function `filterUnique(nums)` that processes an array, returning a standard array containing only elements that appear **exactly once** in the entire collection.\n\nExample: `[1, 2, 2, 3]` should return `[1, 3]` since `2` has duplicate records.",
  ...
  // Use indexOf and lastIndexOf in combination inside .filter()
        ...
        explanation: "Positional index searches like indexOf and lastIndexOf let you check uniqueness profiles in regular arrays directly.",
        testCases: [
          { id: 1, input: [[1, 2, 2, 3, 4, 4, 5]], expected: [1, 3, 5], description: "Prunes any repeated occurrences elements" },
          { id: 2, input: [[1, 1, 1]], expected: [], description: "Correctly handles completely duplicate series" }
        ]
      },
      {
        id: "filter-valleys",
...
// [2, 1]`,
  ...
  // Access sibling elements using index params inside callback: .filter((num, index) => ...)
        ...
        explanation: "Evaluating adjacent record boundaries inside filter indices checks geometric array properties cleanly and efficiently.",
        testCases: [
          { id: 1, input: [[5, 2, 8, 1, 9]], expected: [2, 1], description: "Locates intermediate and endpoint valley items" },
          { id: 2, input: [[1, 3, 2]], expected: [1, 2], description: "Correctly evaluates indexes at boundaries" }
        ]
      },
      {
        id: "filter-landmarks",
...
// [3, 4, 5]`,
  ...
  // Update that variable as elements pass through .filter().
        ...
        explanation: "Keeping custom running accumulator thresholds inside filter closures allows evaluating progression paths beautifully.",
        testCases: [
          { id: 1, input: [[3, 1, 4, 2, 5]], expected: [3, 4, 5], description: "Keeps elements that exceed prior progressive records" },
          { id: 2, input: [[10, 5, 3]], expected: [10], description: "Decaying elevations return only the start height" }
        ]
      }
    ]
  },
  {
    ...
    shortDescription: "Combine all the items in an array down into a single value, object, or total.",
    longExplanation: "The `.reduce()` method is incredibly versatile. It lets you loop through an array and build up a single result step-by-step. This result can be a number (like a sum), a string, a brand-new object, or even another array!\n\n- **The Accumulator (Running Total)**: Think of the accumulator as a basket. As you visit each item, you update what's in the basket and pass it to the next step.\n- **Starting Value**: You always decide what the basket starts with (e.g., `0` for a sum, or `[]` for a list).",
...
console.log(totalProduct); // 240 (10 * 2 * 3 * 4)`,
    exercises: [
      {
        ...
        conceptContext: "Instead of doing array sorting or math functions, comparing values element-by-element inside a reduce loop isolates maximums cleanly.",
        description: "Write a function `findMax(nums)` that takes an array of numbers and returns the maximum value in the array using `.reduce()`. If the array is empty, return `-Infinity`.",
  ...
  // Use .reduce() to traverse and locate the largest number, starting the accumulator at -Infinity
        ...
        explanation: "Evaluating comparative maximums during reduction reduces auxiliary memory allocations to zero.",
        testCases: [
          { id: 1, input: [[-10, 5, 20, -2]], expected: 20, description: "Extracts highest positive boundary accurately" },
          { id: 2, input: [[]], expected: -Infinity, description: "Returns -Infinity for empty array fields" }
        ]
      },
      {
...
// 240`,
  ...
  // Reduce the values starting from initialMultiplier
        ...
        explanation: "Simple multiplication reduction demonstrating initializing accumulator variables securely.",
        testCases: [
          { id: 1, input: [[2, 3, 4], 10], expected: 240, description: "Multiplies numbers cleanly (10 * 2 * 3 * 4)" }
        ]
      },
      {
        ...
        conceptContext: "Financial and cart calculations frequently summarize nested quantities using a seed starting at zero.",
        description: "Write a function `computeCartTotal(items)` that takes an array of items: `{ price, multiplier, count }` and returns the aggregated billing total using `.reduce()`. Check if a `multiplier` exists on the item and apply it: `price * count * multiplier` (default multiplier to `1` if undefined). Start the accumulator at `0`.",
  ...
  // Accumulate total with .reduce() checking multiplication rules
        ...
        explanation: "Using fallback logical OR boundaries for optional properties ensures clean billing math.",
        testCases: [
          { id: 1, input: [[{ price: 10, count: 2, multiplier: 1.5 }, { price: 5, count: 4 }]], expected: 50, description: "Computes quantities and multipliers correctly" }
        ]
      },
      {
        id: "reduce-flatten",
...
// [1, 2, 3, 4, 5]`,
        conceptContext: "An empty array initialized as the accumulator can be concatenated sequentially with nested rows inside a map closure.",
        description: "Now, let's learn how to flatten complex matrices without using the built-in `.flat()` array method.\n\nWrite a function `flattenGrid(grid)` that processes an array of nested arrays, merging them into a single 1D flat array using `.reduce()`.",
  ...
  // Melt nested grid array rows into a 1D collection
        ...
        explanation: "Merging nested levels is necessary when compiling raw spreadsheet row grids prior to parsing datasets.",
        testCases: [
          { id: 1, input: [[[1, 2], [3, 4], [5]]], expected: [1, 2, 3, 4, 5], description: "Concatenates rows to single dimension array" }
        ]
      },
      {
        id: "reduce-pivot-map",
        ...
        conceptContext: "Grouping or index-mapping arrays of database objects into custom key-indexed maps speeds up search queries significantly.",
        description: "Let's pivot our rows! Write a function `pivotUserMap(users)` that takes an array of user objects: `{ id, name, role }` and reduces them into a single object keyed by each user's unique `id` property.",
  ...
  // Use .reduce() with an initial accumulator of an empty object {}
        ...
        explanation: "Pivoting rows into records simplifies linking active items with external state IDs.",
        testCases: [
          { id: 1, input: [[{ id: "u1", name: "Alice" }, { id: "u2", name: "Bob" }]], expected: { u1: { id: "u1", name: "Alice" }, u2: { id: "u2", name: "Bob" } }, description: "Re-keys array items into object dictionary maps successfully" }
        ]
      },
      {
...
// { dog: 2, cat: 1 }`,
        conceptContext: "To count element counts, initialize with an empty object dictionary. In the callback, if the key does not exist yet inside accumulator, fallback to 0 and increment.",
        description: "Let's build on the object accumulator by dynamic key tallying!\n\nWrite a function `tallyFrequencies(words)` that reads an array of strings. It must return an object counting the occurrences of each word (word -> count matches).\n\nExample: `['apple', 'banana', 'apple']` -> `{ apple: 2, banana: 1 }`.",
  ...
  // Build a vocabulary tally count using an empty object accumulator {}
        ...
        explanation: "Object tally tracking is the perfect prerequisite to hash map lookups.",
        testCases: [
          { id: 1, input: [["dog", "cat", "dog", "bird"]], expected: { dog: 2, cat: 1, bird: 1 }, description: "Tallies animals frequencies accurately" }
        ]
      },
      {
...
// { evens: [2, 4], odds: [1, 3] }`,
        conceptContext: "The initial value can be an object instead of a primitive. Be sure to push to nested arrays and return the updated accumulator reference from each callback step.",
        description: "Now let's transition from accumulating single numbers to aggregating into *objects* with nested lists!\n\nWrite a function `partitionParity(nums)` that takes an array of integers and splits them into an object with two keys:\n- `evens`: An array containing all even values.\n- `odds`: An array containing all odd values.\n\nSolve this strictly inside a single functional `.reduce()` statement.",
  ...
  // Map integers, initializing the reduce with custom object: { evens: [], odds: [] }
        ...
        explanation: "Grouping and classifying arrays into key-value map indices is a classic database aggregation scenario.",
        testCases: [
          { id: 1, input: [[1, 2, 3, 4]], expected: { evens: [2, 4], odds: [1, 3] }, description: "Partitions integers correctly" }
        ]
      },
      {
        ...
        conceptContext: "Combining dynamic array creation and lookup keys inside one reduction loop builds complete category group dictionaries.",
        description: "Write a function `groupByGrade(students)` that takes an array of student objects: `{ name, grade }` (where `grade` is a string letter like `'A'`, `'B'`).\n\nIt should reduce the list into a single grouping object where each key is a grade and the value is a standard array of student strings (`name`) corresponding to that grade.\n\nExample:\n`[{ name: 'Alice', grade: 'A' }, { name: 'Bob', grade: 'B' }, { name: 'Charlie', grade: 'A' }]` -> `{\n  A: ['Alice', 'Charlie'],\n  B: ['Bob']\n}`.",
  ...
  // Reduce students into a group lookup object, starting with {}
        ...
        explanation: "Reducing array tracks to categorized lists performs structured analytics transformations instantly.",
        testCases: [
          { id: 1, input: [[{ name: "Alice", grade: "A" }, { name: "Bob", grade: "B" }, { name: "Charlie", grade: "A" }]], expected: { A: ["Alice", "Charlie"], B: ["Bob"] }, description: "Assembles clean group list buckets keyed by grade" }
        ]
      },
      {
        id: "reduce-pipeline",
        ...
        conceptContext: "Reducers are the canonical way to execute functional compositions, passing the resulting output of each step into the subsequent callback.",
        description: "Write a function `composeFunctions(initialVal, pipeline)` that takes a starting value and an array of mathematical functions. It should use `.reduce()` to pass the running value through each function in the pipeline in order, returning the final transformed output.",
  ...
  // Use .reduce() to pipe initialVal through each function in pipeline
        ...
        explanation: "Pipeline compositions structure middleware frameworks like Redux and Express.",
        testCases: [
          { id: 1, input: [100, [x => x / 2, x => x - 10]], expected: 40, description: "Flows variable inputs through sequence boundaries sequentially" }
        ]
      },
      {
...
// [["a", 2], ["b", 3], ["a", 1]]`,
        conceptContext: "Reductions can read historical records inside their active accumulator container to determine whether to combine or push data.",
        description: "To complete the `.reduce()` system, let's solve a real sequence data compression algorithm.\n\nWrite a function `runLengthEnc(chars)` that uses `.reduce()` to compress sequential duplicate elements.\n\nIt should return an array of arrays, where each sub-array contains `[char, count]`.\n\nExample:\n`['a', 'a', 'b', 'b', 'b', 'a']` -> `[['a', 2], ['b', 3], ['a', 1]]`.",
  ...
  // Compress repeating subsequences into paired tracks
        ...
        explanation: "Compression pipelines check immediate history inside reduction blocks to bundle repetitive signals efficiently.",
        testCases: [
          { id: 1, input: [["a", "a", "b", "b", "b", "a"]], expected: [["a", 2], ["b", 3], ["a", 1]], description: "Segments character tracks securely" }
        ]
      }
    ]
  },
  {
    ...
    shortDescription: "Use JavaScript objects as custom dictionaries to lookup information instantly.",
    longExplanation: "Standard arrays are great, but finding an item in a huge list can be slow because you might have to scan the whole array. JavaScript objects let you store things as key-value pairs (like a word and its definition) so you can find them instantly.\n\n- **Instant Lookups**: Checking if a key exists is super fast using the `in` keyword (e.g., `'username' in user`).\n- **Smart Caching**: You can save results in an object as you calculate them, so you never have to do the same work twice.",
...
// { host: "127.0.0.1", port: 3000 }`,
        conceptContext: "The ES6 Spread operator clones dictionary properties into brand new objects: properties inside active override elements update existing matching default keys safely.",
        description: "Let's warm up with basic object key manipulation and fallback searches.\n\nWrite a function `mergeConfig(defaults, overrides)` that takes a defaults dictionary and overrides list of keys.\n\nIt should return a new object containing the default configuration values, except where overriding parameters are provided inside `overrides`.",
  ...
  // Hint: Rest/Spread operators can do this in one line!
        ...
        explanation: "Immutable dictionaries merges prevent side-effects on client settings profiles.",
        testCases: [
          { id: 1, input: [{ theme: "light", debug: false }, { theme: "dark" }], expected: { theme: "dark", debug: false }, description: "Applies explicit replacements over standard default entries" }
        ]
      },
      {
        id: "object-two-sum",
...
// result is [0, 1]`,
        conceptContext: "Instead of searching for matching pairs using nested loops, caching checked numbers in a lookup dictionary resolves target matches in constant O(1) time per element.",
        description: "Let's build on basic dictionary lookups to solve a classic DSA algorithm in linear time!\n\nWrite a function `twoSumLookup(nums, target)` that seeks the index positions of two numbers in `nums` that add up to `target`.\n\nYou must achieve **O(N) linear runtime** by using an object as a coordinate lookup tracker. Nested loops are forbidden!",
  ...
  const seen = {}; // num -> index
        ...
        explanation: "Caching past items prevents expensive secondary passes, solving requirements in high speed linear O(N) times.",
        testCases: [
          { id: 1, input: [[2, 7, 11, 15], 9], expected: [0, 1], description: "Matches indices 0 and 1 representing 2 and 7" },
          { id: 2, input: [[3, 2, 4], 6], expected: [1, 2], description: "Matches duplicate sums in list" }
        ]
      },
      {
...
// charCount is { a: 1, p: 2, l: 1, e: 1 }`,
        conceptContext: "An anagram has identical character balance counts. Building occurrence tallies with objects compares string signatures instantly without sorting lists.",
        description: "Now, let's compare two datasets using maps of character occurrences.\n\nWrite a function `isAnagramLookup(s, t)` which verifies if strings `s` and `t` are anagrams in strict **O(N)** time.\n\nAn anagram contains identical letters in exactly the same quantities (frequency counts).",
  ...
  // 3. Loop through t and decrement or check counts.
        ...
        explanation: "Frequency dictionaries process string comparisons in a single O(N) pass, outperforming standard O(N log N) sorts.",
        testCases: [
          { id: 1, input: ["listen", "silent"], expected: true, description: "Identical letter quantities detected" },
          { id: 2, input: ["rat", "car"], expected: false, description: "Letters do not align matches" }
        ]
      },
      {
...
// { Dev: ["Ann", "Val"] }`,
  ...
  // { HR: ["Alice", "Charlie"], IT: ["Bob"] }
        ...
        explanation: "Database systems index table indices into dynamic sub-arrays for fast structural queries.",
        testCases: [
          { id: 1, input: [[{ name: "Alice", dept: "HR" }, { name: "Bob", dept: "IT" }, { name: "Charlie", dept: "HR" }]], expected: { HR: ["Alice", "Charlie"], IT: ["Bob"] }, description: "Segments departments list correctly" }
        ]
      },
      {
...
const findStart = !(100 - 1 in lookup); // true (100 is start)`,
  ...
  // 3. From there, count up (num + 1, num + 2, etc.) to calculate the sequence length.
        ...
        explanation: "Hashing ensures constant time O(1) checks which allows tracking long contiguous runs in strict O(N) intervals.",
        testCases: [
          { id: 1, input: [[100, 4, 200, 1, 3, 2]], expected: 4, description: "Locates streaks representing 1, 2, 3, 4" },
          { id: 2, input: [[0, 3, 7, 2, 5, 8, 4, 6, 0, 1]], expected: 9, description: "Large mixed dataset checked instantly" }
        ]
      }
    ]
  },
  {
    ...
    shortDescription: "Create functions that remember variables from where they were first defined.",
    longExplanation: "A closure happens when an inner function remembers and has access to the variables of its outer function, even after the outer function has finished running. Think of it as a function with 'memory'.\n\n- **Private Data (Secret Bags)**: You can hide variables inside a function so that external code cannot touch or mess with them.\n- **Custom Factories**: You can write a function that creates other functions with customized pre-saved settings.",
...
myCounter.add(); // 11`,
  ...
  // Return methods that close over and manipulate this count safely
        ...
        explanation: "Encapsulating internal values prevents external scripts from directly corrupting core variables.",
        testCases: [
          {
            id: 1,
            input: [10],
            expected: [11, 10, 10],
            description: "Correctly increments, decrements, and fetches values sequentially",
          }
        ]
      },
      {
...
double(5); // 10`,
        conceptContext: "Outer configuration variables get sealed inside custom functions returned as formulas.",
        description: "Building on private state retention, let's create custom mathematical functions initialized with configuration options.\n\nWrite a function `createScaler(factor)` that returns an inner function. That returned function should take a number `n` and return the product of that number and the encapsulated `factor`.",
  ...
  // Return an anonymous function that multiplies its argument by the outer 'factor'
        ...
        explanation: "Function factories allow pre-configuring custom reusable arithmetic configurations beautifully.",
        testCases: [
          { id: 1, input: [5, 10], expected: 50, description: "Correctly scales parameter 10 by factor 5" },
          { id: 2, input: [2.5, 4], expected: 10, description: "Scales fractional values correctly" }
        ]
      },
      {
        id: "closure-auth",
...
store.has(); // true`,
  ...
  // Encapsulate a private token variable within the closure environment
        ...
        explanation: "Token managers prevent credentials exposure in open client scopes.",
        testCases: [
          { id: 1, input: ["API-SEC-982"], expected: [true, false], description: "Verifies token saving, tracking, and deletion" }
        ]
      },
      {
        id: "closure-memoize",
...
square(4); // 16 (retrieves from cache)`,
  ...
  // Return an inner function that intercepts incoming values
        ...
        explanation: "Memoization caches save processing power on identical computationally heavy calls.",
        testCases: [
          { id: 1, input: [8], expected: 16, description: "Computes once, while secondary lookups fetch from cached keys" }
        ]
      },
      {
        id: "closure-stream",
...
streamer(20); // 15`,
  ...
  // Encapsulate an array of received elements in closure memory
        ...
        explanation: "Continuous window statistics trackers parse rolling streams securely inside functional closures.",
        testCases: [
          { id: 1, input: [3, [10, 20, 30, 40]], expected: [10, 15, 20, 30], description: "Computes active sliding averages for period 3 windows" }
        ]
      }
    ]
  },
  {
    ...
    shortDescription: "Split, search, clean, and rebuild string text in JavaScript easily.",
    longExplanation: "In JavaScript, you cannot change a string directly—once created, it is set in stone. To modify text, you use helper methods to create fresh, updated strings. Mastering these text tools is essential for cleaning up dirty user inputs or parsing raw data.\n\n- **Slicing and Splitting**: Use `.split()` to cut text into chunks, `.join()` to glue elements together, `.slice()` to grab specific segments, and `.trim()` to sweep away clumsy spaces.",
...
const greeting = \`Hello, \${user}!\`; // "Hello, Alice!"`,
        conceptContext: "Template literals inside backticks (`) allow seamless variable and expression injection via standard ${} markers.",
        description: "Let's practice the most common way to build modern strings in JavaScript: using backticks and string interpolation!\n\nWrite a function `greetUser(name, role)` that uses a template literal to construct a customized greeting line.\n\nIt should return exactly: `\"Welcome [name], your role is [role]\"`",
  ...
  // Return a template literal combining name and role
        ...
        explanation: "Dynamic string interpolation replaces old string concatenation, creating cleaner and highly readable layouts.",
        testCases: [
          { id: 1, input: ["Alice", "admin"], expected: "Welcome Alice, your role is admin", description: "Interpolates name 'Alice' and role 'admin'" },
          { id: 2, input: ["Bob", "moderator"], expected: "Welcome Bob, your role is moderator", description: "Interpolates name 'Bob' and role 'moderator'" }
        ]
      },
      {
...
const clean = message.trim(); // "Hello"`,
        conceptContext: "The `.trim()` method removes empty space characters from both the beginning and end of a string without altering the internal text gaps.",
        description: "Scrub messy inputs by sweeping away accidental spaces at the start or end of a string using `.trim()`!\n\nWrite a function `cleanUsername(username)` that receives a string and returns it with all leading and trailing whitespaces removed.",
  ...
  // Remove leading and trailing spaces
        ...
        explanation: "Cleaning input fields validates names and search queries safely before executing database lookups.",
        testCases: [
          { id: 1, input: ["   sarah_connor   "], expected: "sarah_connor", description: "Trims wide borders of leading and trailing spaces successfully" },
          { id: 2, input: ["john_doe"], expected: "john_doe", description: "Leaves properly structured names intact" }
        ]
      },
      {
...
const normal = userEmail.toLowerCase(); // "sarah.connor@skynet.com"`,
        conceptContext: "Using `.toLowerCase()` or `.toUpperCase()` normalizes input elements, securing lookup matching keys from erratic casing mismatches.",
        description: "Make user searches or credentials case-insensitive by normalizing text to lower or upper case!\n\nWrite a function `normalizeEmail(email)` that receives a string and returns a completely lowercased version of the email address.",
  ...
  // Convert input email string to lowercase
        ...
        explanation: "Normalizing data ensures that comparisons like 'User@Mail.com === user@mail.com' resolve securely to true.",
        testCases: [
          { id: 1, input: ["Sarah.Connor@Skynet.Com"], expected: "sarah.connor@skynet.com", description: "Normalizes a mix of upper and lower case letters" },
          { id: 2, input: ["ADMIN@domain.org"], expected: "admin@domain.org", description: "Slashes general all-cap inputs down" }
        ]
      },
      {
...
"WARNING 123".replace(/[0-9]/g, ""); // "WARNING "`,
  ...
  // 3. Otherwise return "INVALID"
        ...
        explanation: "Combining basic string searches like startsWith and includes with powerful regular expression swaps cleans complex inputs without complex loop logic.",
        testCases: [
          { id: 1, input: ["[SECURE] SERVER ALERT WARNING 911"], expected: "[SECURE] SERVER ALERT WARNING ", description: "Valid secure message with digits cleaned" },
          { id: 2, input: ["[PUBLIC] WARNING LEVEL 4"], expected: "INVALID", description: "Fails prefix check and returns INVALID" },
          { id: 3, input: ["[SECURE] STANDARD DATA OK 200"], expected: "INVALID", description: "Fails keyword check and returns INVALID" }
        ]
      },
      {
...
const part = text.slice(0, 4); // "Java"`,
        conceptContext: "Extracting specific subsets of characters is simplified using standard string `.slice(startIndex, endIndexExclusive)` offsets.",
        description: "Extract portions of text from a string using ranges with `.slice(start, end)`!\n\nWrite a function `getAreaCode(phoneNumber)` that extracts and returns only the first three characters of a phone number string.",
  ...
  // Extract the first 3 characters representing the area code
        ...
        explanation: "Slicing slices complex logs and formatting phone codes into localized regional blocks easily.",
        testCases: [
          { id: 1, input: ["415-555-2671"], expected: "415", description: "Extracts area code from formatted phone blocks" },
          { id: 2, input: ["2129876543"], expected: "212", description: "Processes uniform numeric buffers smoothly" }
        ]
      },
      {
...
// "<span class=\"TAG-BLUE\">Save</span>"`,
  ...
  // Clean the label, transform the variant, and format the output HTML button tag
        ...
        explanation: "Combining multiple string methods enables declarative generation of robust UI views without risking formatting visual leaks.",
        testCases: [
          { id: 1, input: ["  Save Config  ", "primary"], expected: "<button class=\"BTN-PRIMARY\">Save Config</button>", description: "Fuses trimmed label and uppercased primary class variant together" },
          { id: 2, input: ["Delete Record", "danger"], expected: "<button class=\"BTN-DANGER\">Delete Record</button>", description: "Properly formats danger state classes and preserves input sizes" }
        ]
      }
    ]
  },
  {
    ...
    shortDescription: "Find specific elements and verify check status rules in list arrays.",
    longExplanation: "Searching through lists is a fundamental task. Instead of writing long and repetitive loop lines, JavaScript gives you built-in methods to query your data directly and elegantly.\n\n- **`.find()`**: Grabs the very first item that matches your custom search rule.\n- **`.some()`**: Returns `true` if at least one item matches your rule, and immediately stops searching.\n- **`.every()`**: Checks if *every single* item in the array passes your rule, returning `false` the moment one fails.",
...
const firstPositiveLog = logs.find(num => num > 0);
// 4`,
        conceptContext: "The `.find()` utility walks your collection left-to-right and extracts the first single item that triggers your true/false test, returning undefined immediately if no items pass.",
        description: "Let's warm up with basic search lookups.\n\nWrite a function `firstPositive(nums)` that takes an array of numbers and returns the **first** element that is strictly positive (`> 0`). If no positive numbers exist, return `undefined`.",
  ...
  // Use .find() to return the first positive number
        ...
        explanation: "Finding individual occurrences simplifies searching sorted databases on target coordinates.",
        testCases: [
          { id: 1, input: [[-10, -5, 0, 7, -2, 12]], expected: 7, description: "Locates first positive integer successfully" },
          { id: 2, input: [[-1, -2, -3]], expected: undefined, description: "Returns undefined when sequence doesn't contain positive values" }
        ]
      },
      {
...
// true`,
        conceptContext: "The `.some()` utility performs an existential verification. It yields true if at least one item satisfies your condition, halting the search immediately on the first match.",
        description: "Verify safety conditions across dynamic collections.\n\nWrite a function `hasUnderage(ages, limit)` that checks whether there resides any customer in the array `ages` whose age is strictly less than the specified integer `limit`.",
  ...
  // Use .some() to short circuit when compliance limits are violated
        ...
        explanation: "Short-circuit checks avoid scanning complete arrays once violations are triggered.",
        testCases: [
          { id: 1, input: [[21, 25, 18, 30], 21], expected: true, description: "Correctly identifies presence of underage value (18)" },
          { id: 2, input: [[25, 30, 42], 21], expected: false, description: "Accurately passes all-compliant lists" }
        ]
      },
      {
...
// true`,
        conceptContext: "The `.every()` helper enforces strict general collection compliance. It ensures that every single item conforms to your testing criteria, returning false right away if a single failure is detected.",
        description: "Enforce strict compliance standards across dynamic transaction collections.\n\nWrite a function `allEvenPositives(nums)` that checks if **all** numbers inside `nums` are both even (`x % 2 === 0`) AND strictly positive (`x > 0`).",
  ...
  // Use .every() to assert that all elements satisfy your double requirement
        ...
        explanation: "Asserting universal rules across data elements validates datasets integrity beautifully.",
        testCases: [
          { id: 1, input: [[2, 4, 8, 10]], expected: true, description: "Asserts positive check on all-even list" },
          { id: 2, input: [[2, -4, 8]], expected: false, description: "Successfully rejects list because of negative item" },
          { id: 3, input: [[2, 5, 8]], expected: false, description: "Successfully rejects list because of odd item" }
        ]
      },
      {
...
// 3 (representing 'l')`,
        conceptContext: "Checking item frequencies inside sequences is solved by monitoring positional indices. If the first discovered position of a character is different from its current index, it has been encountered before.",
        description: "Locate the primary duplicate item within streams!\n\nWrite a function `firstRepeatingChar(str)` that scans a string and returns the **first** character that appears more than once.\n\nExample: `'abcdefb'` should return `'b'` since it represents the first letter we encounter a duplicate for.",
  ...
  // Use .find() or standard loop with indexOf checking to find duplicate positions
        ...
        explanation: "Positional checking isolates repeating tokens easily in single iteration sweeps.",
        testCases: [
          { id: 1, input: ["abcdefb"], expected: "b", description: "Locates first repeating character accurately" },
          { id: 2, input: ["xyz"], expected: undefined, description: "Returns undefined when all characters are entirely unique" }
        ]
      },
      {
...
// true`,
  ...
  // Loop using parent pointer 'i' and inner pointer 'j' (or sliding windows) to track continuous totals
        ...
        explanation: "Continuous index searches solve classic pipeline scheduling and buffers limit validations.",
        testCases: [
          {
            id: 1,
...
// "a@b.com"`,
  ...
  // or return 'No coordinate profile found' if any part of the path is missing.
        ...
        explanation: "Protecting pathway queries prevents deep API structures from crashing web applications.",
        testCases: [
          {
            id: 1,
          ...
          },
          {
            ...
            description: "Correctly handles incomplete nested properties without crashing",
          }
        ]
      },
      {
...
// 0`,
  ...
  // If the setting is omitted or undefined, return true. Ensure explicit false configurations remain preserved.
        ...
        explanation: "Nullish checks accurately distinguish defined false flags from missing properties.",
        testCases: [
          {
            id: 1,
...
// -1`,
        conceptContext: "Matrix lookups are protected by checking parent rows before indexing column cells. Chaining bracket notation prevents out-of-bounds runtime errors.",
        description: "Shield multi-dimensional array indexes from throwing out-of-bounds runtime errors!\n\nWrite a function `safeMatrixLookup(grid, row, col)` that securely fetches a single slot value inside a 2D grid matrix.\n\nAvoid any script crashes by gracefully returning `-1` if the coordinates are out of bounds.",
  ...
  // row and column coordinate index positions. If out of bounds, return -1.
        ...
        explanation: "Bracket chaining guards matrix coordinate searches against unexpected out-of-boundary runtime exceptions.",
        testCases: [
          { id: 1, input: [[[1, 2], [3, 4]], 1, 0], expected: 3, description: "Correctly maps valid row and coordinate indexes" },
          { id: 2, input: [[[5, 6], [7, 8]], 5, 0], expected: -1, description: "Replaces array-out-of-bounds exception with -1 securely" }
        ]
      },
      {
        id: "safe-log-sensor",
...
// "OK"`,
        conceptContext: "Chaining can be merged with dynamic function executions. If a targeted method is not implemented, the statement stops safely and outputs undefined, which can then be bypassed with fallback values.",
        description: "Extract sensor streams from dynamic diagnostic payloads!\n\nWrite a function `getSensorStatus(device)` that retrieves a device's vital health status. Use optional chaining to run `fetchMetrics` safely and fetch the status property, falling back to `'OFFLINE'` if the metrics are not resolved.",
  ...
  // Safely execute optional methods and fall back on static pathways
        ...
        explanation: "Evaluating optional diagnostic methods ensures modular device drivers function safely under missing parameters.",
        testCases: [
          {
            id: 1,
            input: [{ fetchMetrics: () => ({ status: "HEALTHY" }) }],
            expected: "HEALTHY",
            description: "Successfully executes dynamic diagnostic metrics methods",
          },
          {
            id: 2,
...
// resolved is "localhost"`,
  ...
  // If at any step along this path the lookup is null or undefined, return 'PATH_BLOCKED'.
        ...
        explanation: "Dynamic directory path traversal prevents crashes when parsing unstructured deep settings formats.",
        testCases: [
          {
            id: 1,
          ...
          },
          {
            ...
            description: "Yields BLOCKED indicators smoothly under broken branches",
          }
        ]
      }
    ]
  },
  {
    ...
    shortDescription: "Store lists of unique values and eliminate duplicate records effortlessly.",
    longExplanation: "A `Set` is a built-in object in JavaScript that acts like an array, but with one special rule: it can **never** hold duplicate values. If you try to add an item that is already there, the Set will simply ignore it!\n\n- **Super-Fast Checks**: Unlike arrays, which must search from start to finish, a Set can instantly tell you if it contains an item using `mySet.has(value)`.\n- **Quick deduplication**: You can clean all duplicates out of an array in a single line of code: `[...new Set(myArray)]`.",
...
// [1, 2, 3, 4]`,
        conceptContext: "Set data structures represent native lists where each value can exist exactly once. This capability makes them ideal for instant duplicate extraction.",
        description: "Let's warm up with basic Set deduplication.\n\nWrite a function `deduplicateList(arr)` that quickly prunes duplicate values from an array, returning a clean deduplicated array.",
  ...
  // Use Set and spread operators to clear all array duplication
        ...
        explanation: "Set instantiation filters lists instantly, simplifying data sanitization pipelines.",
        testCases: [
          { id: 1, input: [[5, 2, 8, 2, 5, 12]], expected: [5, 2, 8, 12], description: "Deduplicates numbers list safely" },
          { id: 2, input: [[1, 1, 1, 1]], expected: [1], description: "Collapses identical items cleanly" }
        ]
      },
      {
...
// [2, 3]`,
        conceptContext: "Overlapping values in two lists can be found efficiently. Converting one list to a Set gives us fast search capabilities, avoiding high computational overhead.",
        description: "Let's perform dynamic set intersection comparisons!\n\nWrite a function `findCommon(arr1, arr2)` that takes two arrays. It should return a deduplicated array containing elements that are present in **both** inputs.\n\nYour code should run in optimum linear **O(N + M)** time using Sets.",
  ...
  // Use a seen Set to filter overlap elements in linear complexity
        ...
        explanation: "Set membership lookups replace slow quadratic O(N²) array loops with high speed linear algorithms.",
        testCases: [
          { id: 1, input: [[1, 2, 2, 3], [2, 3, 4]], expected: [2, 3], description: "Finds common intersecting elements" },
          { id: 2, input: [[5, 9], [1, 2]], expected: [], description: "Correctly handles completely distinct lists" }
        ]
      },
      {
...
// true`,
  ...
  // Compare native sizes to evaluate unique character limits
        ...
        explanation: "Set sizes reflect unique membership profiles, validating duplicates in a single comparison check.",
        testCases: [
          { id: 1, input: ["prism"], expected: true, description: "Identifies entirely distinctive character list" },
          { id: 2, input: ["hello"], expected: false, description: "Catches duplicate characters safely" }
        ]
      },
      {
...
// [1, 3]`,
  ...
  // Find distinct outer parts from both collections
        ...
        explanation: "Set differences identify distinct discrepancies between records pools in scalable, single pass lookups.",
        testCases: [
          { id: 1, input: [[1, 2, 3], [3, 4, 5]], expected: [1, 2, 4, 5], description: "Finds symmetric differences correctly" },
          { id: 2, input: [[1, 1, 2], [2, 2]], expected: [1], description: "Deduplicates exclusive inputs correctly" }
        ]
      },
      {
...
// true`,
  ...
  // Use a seen values Set to track lookup records in linear O(N) complexity
        ...
        explanation: "Tracking history inside Seen sets validates pair associations in single lines of execution.",
        testCases: [
          { id: 1, input: [[10, 15, 3, 7], 17], expected: true, description: "Matches 10 and 7 summing to 17" },
          { id: 2, input: [[1, 2, 3, 9], 8], expected: false, description: "Correctly rejects non matching lists" }
        ]
      }
    ]
  },
  {
    ...
    shortDescription: "Manage asynchronous delays, callbacks, and parallel timers using ES6 Promises.",
    longExplanation: "Unlike synchronous operations that block standard execution, modern JavaScript handles delays and network callbacks using Promises.\n\n- **Promises**: Represents a container for a value that is either resolved now, in the future, or never.\n- **Async / Await**: Clean syntax that pauses line completion until your Promise resolves, cleanly wrapping async procedures in sequential structures.",
...
// Resolves after 100 milliseconds`,
        conceptContext: "Asynchronous delay timers use Promise wrappers around native callback functions, putting resolve actions inside standard setTimeout events.",
        description: "Write a function `delayResolve(value, ms)` that returns a Promise. The Promise should resolve with the given `value` after `ms` milliseconds.",
  ...
  // Return a new Promise resolving with the given value after ms milliseconds
        ...
        explanation: "Delays execution safely, providing standard promise foundations.",
        testCases: [
          { id: 1, input: ["Success", 10], expected: "Success", description: "Resolves with Success" },
          { id: 2, input: [42, 5], expected: 42, description: "Resolves with number 42" }
        ]
      },
      {
...
// Resolves with "retrieved_data"`,
        conceptContext: "Node.js uses error-first callbacks. Wrapping those routines inside Promise constructors allows you to handle successes via resolve triggers and failures via reject triggers.",
        description: "Write a function `promisify(fn)` that takes a function `fn(arg, callback)` where callback has the signature `(error, result)`. Your function should return another function that accepts `arg` and returns a Promise. That Promise resolves with the result or rejects with the error.",
  ...
  // Return a function accepting arg and returning a Promise wrapping callback behavior
        ...
        explanation: "Converts callback interfaces into chainable Promises, enabling compatibility with async/await.",
        testCases: [
          { id: 1, input: ["hello"], expected: "hello!", description: "Resolves callback string on success" },
          { id: 2, input: ["fail"], expected: "Error: Failed", description: "Rejects callback with Node-style error" }
        ]
      },
      {
        id: "promise-all-safe",
...
// [{ status: "fulfilled", value: "data" }, { status: "rejected", reason: "error" }]`,
        conceptContext: "Concurrent processing uses array mappings. Injecting self-contained .catch blocks around individual child nodes prevents single failures from crashing adjacent achievements.",
        description: "Write a function `allSafe(promises)` that accepts an array of Promises and returns a Promise resolving to an array of objects representing their outcomes. Each outcome object must have the shape `{ status: 'fulfilled', value: ... }` on success, or `{ status: 'rejected', reason: ... }` on rejection. Use Promise.all underneath inside standard .then() / .catch() maps.",
  ...
  // Wrap each promise to self-catch and return unified status object, then feed to Promise.all
        ...
        explanation: "Executes promises concurrently while preventing single failures from discarding valid adjacent resolutions.",
        testCases: [
          {
            id: 1,
            input: [[{ val: "A", fail: false }, { val: "B", fail: false }]],
            expected: [{ status: "fulfilled", value: "A" }, { status: "fulfilled", value: "B" }],
            description: "Resolves all inputs gracefully"
          },
          {
            id: 2,
            input: [[{ val: "A", fail: false }, { val: "boom", fail: true }]],
            expected: [{ status: "fulfilled", value: "A" }, { status: "rejected", reason: "boom" }],
            description: "Captures partial error while preserving other resolutions"
          }
        ]
      },
      {
...
async function fetchConfig(apiCall) {
  try {
    ...
    return "default_config";
        ...
        conceptContext: "Structured exception handling guards network operations. Placing async requests in try-catch blocks isolates connection timeouts and supplies fallback datasets.",
        description: "Write an `async` function `fetchUserData(userId, mockFetch)` that calls `mockFetch(userId)` (which returns a Promise resolving to a user object: `{ username }`). Your function should return the uppercase representation of `username`. If the request fails or throws an error, catch the exception cleanly and return `'GUEST'`. Assume mockFetch is provided to you.",
  ...
  // Fetch user data inside a try/catch block, returning uppercase username or fallbacks
        ...
        explanation: "Secures external API requests under reliable try-catch boundary systems.",
        testCases: [
          { id: 1, input: [123], expected: "JOHN_DOE", description: "Successfully parses username to uppercase" },
          { id: 2, input: [999], expected: "GUEST", description: "Swallows API error and returns fallback string GUEST" }
        ]
      },
      {
...
async function tryDownload(getTask) {
  ...
  // Loop up to maxRetries times, awaiting fn() execution and recovering on failures
        ...
        explanation: "Provides robust network request recovery sequences across transient offline phases.",
        testCases: [
          { id: 1, input: [3, 5], expected: "Success", description: "Succeeds on the third attempt under budget limit 5" },
          { id: 2, input: [4, 2], expected: "Error: Fail", description: "Rejects with final error if exhausted maxRetries limit 2" }
        ]
      }
    ]
  },
...
// x is 10, y is 25, z is 0 (fallback)`,
  ...
  // Destructure x, y, and z (with a fallback default of 0) from the input point object
        ...
        explanation: "Destructuring assignments shield operations against undefined parameter properties.",
        testCases: [
          { id: 1, input: [{ x: 5, y: 12, z: 20 }], expected: [5, 12, 20], description: "Extracts coordinates completely with explicit z" },
          { id: 2, input: [{ x: 8, y: 3 }], expected: [8, 3, 0], description: "Gracefully falls back to 0 when z is absent" }
        ]
      },
      {
        id: "merge-profile",
...
// filteredPayload is { id: 1, data: "open" }`,
  ...
  // Merge both collections, and filter out dbToken cleanly via rest destructuring
        ...
        explanation: "Stripping security variables is clean and safe using ES6 rest/destructuring patterns.",
        testCases: [
          { id: 1, input: [{ name: "Sam", age: 19, dbToken: "XYZ_883" }, { age: 20, status: "active" }], expected: { name: "Sam", age: 20, status: "active" }, description: "Updates properties correctly while deleting database credentials" }
        ]
      },
      {
        id: "gather-rest-sum",
...
// 12`,
  ...
  // Capture dynamic values inside numbers array, aggregate them, and multiply by multiplier
        ...
        explanation: "Flexible signatures allow writing fluid, high-reusability SDK helper interfaces.",
        testCases: [
          { id: 1, input: [10, 1, 2, 3], expected: 60, description: "Combines 1+2+3 (6) and scales by 10 (60)" },
          { id: 2, input: [4], expected: 0, description: "Correctly evaluates to 0 when no extra numbers are supplied" }
        ]
      },
      {
...
// { ui: { theme: "light", font: "Inter" } }`,
  ...
  // Use spread operators on both parent and nested levels to blend configuration setups safely
        ...
        explanation: "Preserving nested properties rather than wiping them is a vital part of configuring settings clients.",
        testCases: [
          {
            id: 1,
            input: [{ debug: true, theme: { primary: "blue", density: "compact" } }, { port: 3000, theme: { primary: "yellow" } }],
            expected: { debug: true, port: 3000, theme: { primary: "yellow", density: "compact" } },
            description: "Merges root attributes and nested theme setups correctly"
          }
        ]
      },
      {
...
// topLeft is 1, bottomRight is 4`,
  ...
  // Unpack coords cleanly via nested array destructuring pattern to swap positions instantly
        ...
        explanation: "Array destructuring swaps data structures cleanly without relying on manual temporary index holders.",
        testCases: [
          { id: 1, input: [[[[1, 2], [3, 4]]]], expected: [[4, 3], [2, 1]], description: "Swaps coordinates values and sub-arrays perfectly" }
        ]
      }
    ]
  },
  {
    ...
    shortDescription: "Build structural templates to create objects with custom data and actions.",
    longExplanation: "Classes are blueprints for creating objects with matching shapes and actions. Instead of manually writing individual objects, you construct a template class so you can easily instantiate hundreds of matching instances.\n\n- **The Constructor**: A special function that runs once when you create a new object (using the `new` keyword) to set up initial variables.\n- **Subclasses and Inheritance**: Create specialized blueprints that inherit all properties and actions from a parent template (using the `extends` keyword).",
...
// item is { title: "Dune" }`,
  ...
  // Implement constructor setting title and author, with a getDetails method
        ...
        explanation: "Classes act as predictable code structure packages, mapping characteristics to modular services.",
        testCases: [
          { id: 1, input: ["The Hobbit", "J.R.R. Tolkien"], expected: "The Hobbit by J.R.R. Tolkien", description: "Formats book details accurately" }
        ]
      },
      {
...
// stash.cash remains 0`,
  ...
  // Implement constructor with getter/setter balance protecting against negative deposits
        ...
        explanation: "Getters and setters enforce validation constraints on important internal data.",
        testCases: [
          { id: 1, input: ["ACC101", 500], expected: [500, 1200, 1200], description: "Grants legal deposits while silently rejecting negative values" }
        ]
      },
      {
        id: "oop-vector",
...
// basePt.x is still 5, shiftedPt.x is 15`,
        conceptContext: "Immutable objects avoid changing their inner properties, and instead return brand new class instances whenever calculations are performed.",
        description: "Perform coordinate calculation rules without corrupting original points datasets.\n\nCreate a class `Vector` that has:\n- Constructor accepting `x` and `y` numeric values.\n- A method `add(otherVector)` which adds coordinate fields cleanly, returning a brand new Vector instance with the resulting sum indices. (Original vectors must remain unchanged).",
  ...
  // Create an arithmetic vector class that produces new vector products immutably
        ...
        explanation: "Immutable class operations prevent side-effects in complex graphics engines.",
        testCases: [
          { id: 1, input: [[1, 5], [10, 20]], expected: [11, 25], description: "Immutably unions vectors accurately" }
        ]
      },
      {
...
class ElectricCar extends Vehicle {
  // Extend Vehicle, implementing super constructor calls and overriding details description
        ...
        explanation: "Inheritance avoids coding duplications, managing nested entities structure cleanly.",
        testCases: [
          { id: 1, input: ["Tesla", "Model S", 100], expected: "Tesla Model S (100 kWh)", description: "Constructs electric subclasses correctly" }
        ]
      },
      {
        id: "oop-min-stack",
...
class TrackingStack {
  ...
  getMin() {
        ...
        explanation: "Bundling advanced algorithms inside class types is the core foundation of high speed SDK engineering.",
        testCases: [
          { id: 1, input: [[10, 20, 5, 30]], expected: [5, 10], description: "Registers values and fetches minimums securely at any given layer of pop operations" }
        ]
      },
      {
  ...
  get(key) {
        ...
        explanation: "The Singleton pattern ensures resource-heavy registries (like database pools or logging aggregators) are never duplicated needlessly.",
        testCases: [
          {
            id: 1,
            input: ["super-secret-firebase-api-key"],
            expected: [true, "super-secret-firebase-api-key"],
            description: "Verifies that multi-instantiated Registry references match and retrieve shared keys"
          }
        ]
      },
      {
  ...
  publish(event, ...args) {
    // Invoke all registered callbacks of this event using rest parameter arguments
        ...
        explanation: "PubSub models form the backbone of state synchronization engines and layout render queues.",
        testCases: [
          {
            id: 1,
            input: ["click", "data-payload-125"],
            expected: ["data-payload-125", 0],
            description: "Correctly publishes event parameters to multiple subscribers, and stops after unsubscription"
          }
        ]
      },
      {
  ...
  build() {
        ...
        explanation: "The Builder pattern decouples complex, multi-variable object constructions from constructor initializers, making API suites readable.",
        testCases: [
          {
            id: 1,
            ...
            description: "Correctly chaining methods yields a perfectly assembled and matching database query model"
          }
        ]
      }
    ]
  },
  {
    ...
    shortDescription: "Master Map and WeakMap collections for advanced key-value pairing and private metadata.",
    longExplanation: "While traditional JavaScript Objects map keys to values, they are limited to string or symbol keys and are subject to prototype pollution.\n\n- **ES6 Map**: Allows *any* value (numbers, objects, or functions) to serve as keys, remembers insertion order, and tracks count via `.size`.\n- **ES6 WeakMap**: Keys must be objects and are held weakly, allowing garbage-collection reclaiming memory when objects are dereferenced.",
...
// scores.get("item") is 1`,
        conceptContext: "ES6 Maps provide a prototype-safe lookup profile, establishing keys that are independent of built-in object properties and prototype inheritance chains.",
        description: "Write a function `frequencyMap(arr)` that tallies occurrences of strings inside an array. It should return an ES6 `Map` mapping each unique element to its total frequency count.",
  ...
  // Return an ES6 Map counting element frequencies
        ...
        explanation: "Maintains unique key counts cleanly without colliding on inherited Object prototype keys.",
        testCases: [
          { id: 1, input: [["apple", "banana", "apple"]], expected: new Map([["apple", 2], ["banana", 1]]), description: "Tally frequency of fruit strings in Map" }
        ]
      },
      {
        id: "map-object-keys",
...
// nodesRegistry.get(elementNode) is { clicked: true }`,
        conceptContext: "Unlike plain objects, ES6 Maps allow developers to use objects directly as lookup keys, keeping reference addresses separate from value associations.",
        description: "Write a function `trackSessionStates(sessions, statuses)` that takes an array of session objects and an array of status strings of equal length. Map each object directly to its corresponding status inside an ES6 `Map`. Return the completed Map.",
  ...
  // Map sessions objects to corresponding statuses inside a single ES6 Map
        ...
        explanation: "Demonstrates object reference keys in ES6 Maps, preserving identity boundaries.",
        testCases: [
          {
            id: 1,
            input: [[{ id: 1 }, { id: 2 }], ["active", "idle"]],
            expected: new Map([[{ id: 1 }, "active"], [{ id: 2 }, "idle"]]),
...
// merged has key "A" with value 15`,
        conceptContext: "Map structures are iterable collections, meaning they expose entry, key, and value traversers which can be iterated cleanly via standard loops.",
        description: "Write a function `mergeInventoryMaps(mapA, mapB)` that merges two ES6 Map objects, where keys are item names and values are stock quantities. Return a new Map mapping item names to the combined sum of stock quantities.",
  ...
  // Create a combined Map summing values from mapA and mapB
        ...
        explanation: "Uses native Map iteration capabilities to merge entries efficiently.",
        testCases: [
          {
            id: 1,
            input: [new Map([["apples", 5], ["pears", 3]]), new Map([["pears", 10], ["oranges", 2]])],
            expected: new Map([["apples", 5], ["pears", 13], ["oranges", 2]]),
...
// buckets has "A" mapping to [1, 2]`,
        conceptContext: "Map databases group data by dynamic variables or nested values without suffering from key collision or automatic prototype conversion.",
        description: "Write a function `bulkGroupUsersByRole(users)` that takes an array of user objects: `{ username, role }`. Return an ES6 Map where keys are roles and values are arrays of usernames that have that role.",
  ...
  // Group users into array bucket arrays by their role string
        ...
        explanation: "Enables relational grouping models using Map collections.",
        testCases: [
          {
            id: 1,
            input: [[{ username: "ali", role: "admin" }, { username: "bo", role: "user" }, { username: "cat", role: "admin" }]],
            expected: new Map([["admin", ["ali", "cat"]], ["user", ["bo"]]]),
            description: "Correctly groups usernames into corresponding role buckets"
          }
        ]
      },
      {
...
// lookupCache has dynamic key-value pair that auto-garbage-collects when heavyData reference is dropped`,
        conceptContext: "WeakMaps hold key references weakly. When an object key is dereferenced, its WeakMap cached pair automatically cleanses from system memory, preventing leaks.",
        description: "Write a function `cacheCompute(fn)` that implements object memoization. It should return a function wrapping `fn(obj)`. When called with an object `obj`, if `obj` exists in your internal `WeakMap`, return the cached result. Otherwise, execute `fn(obj)`, record the outcome in the WeakMap, and return the resolved result.",
  ...
  // Use a WeakMap instance to memoize outputs of object inputs
        ...
        explanation: "Binds calculation payloads to objects via WeakMap keys, enabling safe, leak-free caching.",
        testCases: [
          { id: 1, input: [], expected: true, description: "Caches computation and avoids extra execution calls" }
        ]
      }
    ]
  },
  {
    ...
    shortDescription: "Write elegant functions that solve big problems by calling themselves with smaller inputs.",
    longExplanation: "Recursion is a fascinating technique where a function calls **itself** to break down a large problem into smaller, bite-sized tasks. Think of it like nested Russian nesting dolls: you open each layer until you find the prize inside.\n\n- **The Base Case**: Your parachute! This is the core condition that stops the function from calling itself forever. If you forget your base case, your program will crash with a 'stack overflow'.\n- **Ideal for Tree Structures**: Essential for winding through nested menus, folder filesystems, or HTML document branches.",
...
// findPermutationsCount(3) is 6`,
        conceptContext: "Recursive algorithms split tasks into smaller representations of themselves. A strict conditional check (the base case) is mandatory to prevent execution loops.",
        description: "Let's warm up with base-case validation! How it works: In compounding percentages, mathematical permutations, or building probability arrays in graphics engines, recursive formulas model multi-layered combinations elegantly.\n\nWrite a recursive function `factorial(n)` that calculates `n!` recursively. (Do not use loops like `for` or `while`).",
  ...
  // Recursive step: n * factorial(n - 1)
        ...
        explanation: "Computes factorials using call-stack branching to build cumulative values elegantly.",
        testCases: [
          { id: 1, input: [5], expected: 120, description: "5! is equal to 120" },
...
// extract(nestedList) is [1, 2, 3]`,
        conceptContext: "Hierarchical arrays can be expanded by inspecting each list element recursively. Dynamic recursion allows flattening deeply nested arrays.",
        description: "Traverse deep nested hierarchies recursively! How it works: In rendering recursive components (like comments threads or directories menus), elements can be nested inside multiple nested subdirectories. Unpacking them into a linear array is standard practice.\n\nWrite a recursive function `deepFlatten(arr)` that takes an array containing nested arrays of any level of depth, and returns a single flat array.",
  ...
  // Traverse and reduce/loop recursively to assemble items into a single flat array
        ...
        explanation: "Recursively inspecting elements flattens arbitrary depths, mimicking recursive directory crawls perfectly.",
        testCases: [
          { id: 1, input: [[[1, [2, [3, 4]], 5]]], expected: [1, 2, 3, 4, 5], description: "Dismantles depth levels completely" }
        ]
      },
      {
...
// findGrowthRate(4) is 3`,
        conceptContext: "Symmetric branching models complex mathematical growth by creating multiple recursive invocations side-by-side in each execution step.",
        description: "Write a recursive function `fibonacci(n)` that returns the n-th Fibonacci number. Assume n >= 0.",
  ...
  // Base cases: n <= 0 returns 0, n === 1 returns 1
        ...
        explanation: "Models branching recursion by dividing calculations into sub-branches.",
        testCases: [
          { id: 1, input: [6], expected: 8, description: "Calculates the 6th Fibonacci term (8)" },
          { id: 2, input: [1], expected: 1, description: "Calculates the 1st Fibonacci term (1)" }
        ]
      },
      {
...
// sumCountdown(3) is 6`,
        conceptContext: "Accumulating number sequences recursively reduces the value towards the base case, stacking addition frames in memory.",
        description: "Write a recursive function `sumRange(n)` that calculates the sum of all positive integers from 1 up to `n`. For example, `sumRange(4)` should return `10` (4 + 3 + 2 + 1). If `n` is 1 or less, return `n`.",
  ...
  // Base case: if n is 1 or less, return n; otherwise add n to sumRange(n - 1)
        ...
        explanation: "Sums ranges sequentially using stack memory frame structures.",
        testCases: [
          { id: 1, input: [4], expected: 10, description: "Calculates sum of 4 + 3 + 2 + 1" },
          { id: 2, input: [1], expected: 1, description: "Handles single case boundary safely" }
        ]
      },
      {
...
// reverseWord("car") is "rac"`,
        conceptContext: "Strings are modified recursively by slicing characters, recursively processing the remaining slice, and combining parts.",
        description: "Write a recursive function `reverseString(str)` that accepts a string `str` and returns its reversed version. For example, `reverseString('abc')` should return `'cba'`. (Do NOT use loops or native `.split().reverse().join()` methods).",
  ...
  // Otherwise, return the reversed remainder of the substring plus the first letter
        ...
        explanation: "Recursively unwinds string characters backwards using call-stack frames.",
        testCases: [
          { id: 1, input: ["hello"], expected: "olleh", description: "Reverses standard string hello to olleh" },
          { id: 2, input: ["a"], expected: "a", description: "Maintains single-length letter perfectly" }
        ]
      }
    ]
  },
  {
    ...
    shortDescription: "Work with Date objects, calculate time gaps, parse formats, and construct localized relative calendar strings.",
    longExplanation: "Time tracking and calendar scheduling are fundamental requirements in software interfaces. Modern JavaScript provides the `Date` constructor and internationalization APIs for robust temporal manipulations.\n\n- **Date Instance representation**: Houses absolute millisecond offsets from the Unix epoch (January 1, 1970 UTC).\n- **Date Parsing & Methods**: Retrieve or modify calendar boundaries cleanly using local or UTC helper methods.",
...
// 5`,
        conceptContext: "Subtracting Date instances yields their raw difference in milliseconds, which can then be converted into standard calendar days using division operations.",
        description: "Write a function `getDaysBetweenDates(dateStr1, dateStr2)` that accepts two date strings in `YYYY-MM-DD` format and returns the absolute difference in full calendar days as an integer.",
  ...
  // Convert strings to Date objects, divide absolute millisecond difference by standard day multiplier
        ...
        explanation: "Normalizes calendar inputs to millisecond counters for reliable interval arithmetic.",
        testCases: [
          { id: 1, input: ["2026-05-20", "2026-05-27"], expected: 7, description: "Calculates exactly 7 days milestone gap" },
          { id: 2, input: ["2026-05-27", "2026-05-20"], expected: 7, description: "Maintains positive integer offset when order is reversed" }
        ]
      },
      {
        id: "date-weekday",
...
// "Monday"`,
        conceptContext: "JavaScript engines format date points directly to human-friendly week representations using localized calendars and standard formatting helpers.",
        description: "Write a function `getWeekdayName(dateStr)` that accepts a date string in `YYYY-MM-DD` format and returns the full day of the week in English (e.g. `'Monday'`, `'Tuesday'`, `'Wednesday'`).",
  ...
  // Parse date string and return localized weekday string
        ...
        explanation: "Formats timestamp points to human-centric locale outputs using date localized formatting.",
        testCases: [
          { id: 1, input: ["2026-05-25"], expected: "Monday", description: "Correctly identifies 2026-05-25 as Monday" },
          { id: 2, input: ["2026-05-27"], expected: "Wednesday", description: "Correctly identifies 2026-05-27 as Wednesday" }
        ]
      },
      {
        id: "date-add-days",
...
// deadline value is updated to representing May 25, 2026`,
        conceptContext: "Adding day counts cleanly relies on setting setDate metrics relative to active getDate parameters, shielding operations from rollover calculations.",
        description: "Write a function `addDaysToDate(dateStr, days)` that accepts a date string in `YYYY-MM-DD` format and an integer `days`, and returns a new date string in `YYYY-MM-DD` format with the offset applied.",
  ...
  // Increment dates safely, returning flat YYYY-MM-DD formatted strings
        ...
        explanation: "Handles calendar month overflows and leap years transparently using native Date arithmetic.",
        testCases: [
          { id: 1, input: ["2026-05-20", 5], expected: "2026-05-25", description: "Identifies standard offset milestone" },
          { id: 2, input: ["2026-12-31", 1], expected: "2027-01-01", description: "Resolves year rollover boundaries gracefully" }
        ]
      },
      {
        id: "date-is-leap",
...
// true or false`,
        conceptContext: "Divisibility checks identify leap years, validating calendar dates by checking if February possesses an extra day.",
        description: "Write a function `isLeapYear(year)` that checks if a calendar year is a leap year. A year is a leap year if it is divisible by 4, but not by 100, unless it is also divisible by 400.",
  ...
  // Check divisibility rules for leap years
        ...
        explanation: "Employs modular bounds arithmetic to declare leap year alignments accurately.",
        testCases: [
          { id: 1, input: [2024], expected: true, description: "Checks leap year divisible by 4" },
          { id: 2, input: [2026], expected: false, description: "Declares leap year false for standard non-divisible years" }
        ]
      },
      {
...
// "moments ago"`,
        conceptContext: "Produce human relative strings by scaling elapsed timestamp offsets and compiling descriptions according to proportional measurements representing minutes, hours, or days.",
        description: "Write a function `formatRelativeTime(seconds)` that accepts an integer `seconds` representing a positive elapsed time. It should return a string format as follows: if `< 60` return `'X seconds ago'`, if `< 3600` return `'Y minutes ago'`, if `< 86400` return `'Z hours ago'`, and otherwise return `'W days ago'`.",
  ...
  // Perform floor divisions to return formatted scale elapsed text segments
        ...
        explanation: "Formats numeric raw offsets into real-world relative user milestones.",
        testCases: [
          { id: 1, input: [45], expected: "45 seconds ago", description: "Renders seconds interval under 1 minute" },
          { id: 2, input: [120], expected: "2 minutes ago", description: "Renders minutes scale floor interval" },
          { id: 3, input: [7200], expected: "2 hours ago", description: "Renders hours scale floor interval" },
          { id: 4, input: [172800], expected: "2 days ago", description: "Renders days scale floor interval" }
        ]
      }
    ]
  },
...
// lastOpenTag is "[", openTags is ["{"]`,
  ...
  // Use a stack to trace opening brackets and match them against closing brackets
        ...
        explanation: "Brace checking forms the underlying parser compilation framework for matching code syntax trees in modern editors.",
        testCases: [
          { id: 1, input: ["()[]{}"], expected: true, description: "Validates fully closed matching sequences" },
          { id: 2, input: ["(]"], expected: false, description: "Rejects unmatched braces" },
          { id: 3, input: ["([{}])"], expected: true, description: "Validates deeply nested matching sequence" },
          { id: 4, input: ["["], expected: false, description: "Rejects unclosed opening bracket list" }
        ]
      },
      {
...
// buffer is ["a"]`,
  ...
  // Process both input strings through helper stacks to rebuild and compare final words
        ...
        explanation: "The command-stack design pattern handles undo steps and delete registers across user input buffers.",
        testCases: [
          { id: 1, input: ["ab#c", "ad#c"], expected: true, description: "Both sequences map to 'ac' after resolving deletions" },
          { id: 2, input: ["ab##", "c#d#"], expected: true, description: "Handles empty strings correctly (both reduce to empty)" },
          { id: 3, input: ["a#c", "b"], expected: false, description: "Identifies mismatched outcomes: 'c' vs 'b'" }
        ]
      },
      {
...
// pathStack contains ["home", "projects"]`,
  ...
  // Split path elements, process directory traversals using a stack, and join them with /
        ...
        explanation: "Operating system shells dynamically normalize messy path lines down to absolute disk directories using directory trees.",
        testCases: [
          { id: 1, input: ["/home/"], expected: "/home", description: "Frees trailing slashes cleanly" },
          { id: 2, input: ["/home//foo/"], expected: "/home/foo", description: "Collapses repeating path slashes" },
          { id: 3, input: ["/../"], expected: "/", description: "Prevents navigating past root directories" },
          { id: 4, input: ["/a/./b/../../c/"], expected: "/c", description: "Applies parent folder jumps accurately" }
        ]
      },
      {
...
// 10 is greater than numbers[0], resolving index 0's next greater value to 10`,
  ...
  // Use a stack to track pending elements that are looking for their next greater successor
        ...
        explanation: "Monotonic stacks pre-solve upcoming threshold values in continuous stream calculations, optimizing O(N^2) checks to O(N).",
        testCases: [
          { id: 1, input: [[4, 5, 2, 25]], expected: [5, 25, 25, -1], description: "Matches standard list with scattered greater jumps" },
          { id: 2, input: [[13, 7, 6, 12]], expected: [-1, 12, 12, -1], description: "Handles falling values and terminal boundaries correctly" },
          { id: 3, input: [[5, 4, 3, 2, 1]], expected: [-1, -1, -1, -1, -1], description: "Returns -1 for strictly decreasing sequences" }
        ]
      },
      {
...
// push 3, push 4. Reached operator, pop them to sum: 3 + 4 = 7`,
  ...
  // Loop through tokens, push numbers, and evaluate binary expressions utilizing popped operands
        ...
        explanation: "Compiler engines convert nesting mathematical brace expressions into stack queues to safely execute operations on CPU registers.",
        testCases: [
          { id: 1, input: [["2", "1", "+", "3", "*"]], expected: 9, description: "Calculates (2 + 1) * 3 = 9 correctly" },
          { id: 2, input: [["4", "13", "5", "/", "+"]], expected: 6, description: "Computes 4 + (13 / 5) with zero-truncated division cleanly" },
          { id: 3, input: [["10", "6", "9", "3", "+", "-11", "*", "/", "*", "17", "+", "5", "+"]], expected: 22, description: "Correctly handles deep compound calculations and negative signs" }
        ]
      }
    ]
  },
  {
    ...
    shortDescription: "Practice core operations on arrays and objects, like cloning, deleting, and looping keys.",
    longExplanation: "These exercises will help you get comfortable with the absolute essentials of managing lists and objects. You will learn how to add and remove items, clone collections safely, run dynamic checks on properties, and find files or list configurations easily.",
...
// processed is "taskA", taskQueue is ["taskB"]`,
  ...
  // Mutate cart ordering leveraging push, pop, shift, and unshift
        ...
        explanation: "Deepens your baseline knowledge of array order modifiers, using ES6 default parameter safeguards.",
        testCases: [
          { id: 1, input: [["laptop", "mouse"], "push", "keyboard"], expected: ["laptop", "mouse", "keyboard"], description: "Pushes item to end of cart" },
          { id: 2, input: [["laptop", "mouse"], "unshift", "charger"], expected: ["charger", "laptop", "mouse"], description: "Unshifts item to beginning of cart" },
          { id: 3, input: [["laptop", "mouse"], "pop"], expected: ["laptop"], description: "Pops last item out of cart" },
          { id: 4, input: [["laptop", "mouse"], "shift"], expected: ["mouse"], description: "Shifts first item out of cart" }
        ]
      },
      {
...
// clonedList contains ["A", "NEW_B", "C"]`,
  ...
  // Splice new items into catalog, then clone and return using spread operator
        ...
        explanation: "Utilizes splice combined with ES6 spread operations to insert custom sections and return fresh shallow copies.",
        testCases: [
          { id: 1, input: [["shirt", "pants", "hat"], 1, 1, ["shoes", "socks"]], expected: ["shirt", "shoes", "socks", "hat"], description: "Splices index 1, replaces pants with shoes and socks correctly" },
          { id: 2, input: [["apple", "banana"], 0, 2, ["orange"]], expected: ["orange"], description: "Overwrites entire catalog correctly" }
        ]
      },
      {
        id: "ds-shelf-finder",
...
// search is true`,
        conceptContext: "The includes helper performs search validations, verifying structural member coordinates by returning a clean boolean flag.",
        description: "In our warehouse, products are organized across multiple rows of shelves, styled as a 2D multi-dimensional array `shelves` (e.g. `[['apples', 'pears'], ['bananas'], ['lemons']]`). We need to scan our inventory and report which shelf indices contain a target product.\n\nWrite a function `findProductShelves(shelves, target)` that iterates over the outer `shelves` array and checks if the inner shelf contains the `target` product using `includes()`. Return a new array with all matching shelf indices.",
  ...
  // Loop shelves and use the ES6 includes() method to locate shelf numbers containing target product
        ...
        explanation: "Combines looping logic with ES6 includes() boolean presence filters.",
        testCases: [
          { id: 1, input: [[["apples", "pears"], ["bananas"], ["apples", "oranges"]], "apples"], expected: [0, 2], description: "Identifies apple shelf coordinates" },
          { id: 2, input: [[["jeans", "t-shirt"], ["shoes"]], "hat"], expected: [], description: "Returns empty list when item is absent from shelves" }
        ]
      },
      {
...
// core.info is { b: 2 }`,
  ...
  // Modify targetKey using brackets, check and delete purgeKey in profile.preferences
        ...
        explanation: "Validates object mutations and key property checks using dynamic key entries.",
        testCases: [
          {
            id: 1,
            input: [
              { id: 101, username: "alex", preferences: { theme: "light", newsletter: true } },
              "theme",
              "dark",
              "newsletter"
            ],
            expected: { id: 101, username: "alex", preferences: { theme: "dark" } },
            description: "Updates theme preference to dark and deletes the newsletter key successfully"
          },
          {
            id: 2,
            input: [
            ...
            expected: { id: 102, username: "sam", preferences: { fontSize: 14, colorScheme: "high-contrast" } },
            description: "Adds colorScheme safely and leaves structural profile parts intact without errors"
          }
        ]
      },
      {
...
// keys is ["apple", "orange"]`,
  ...
  // Scan inventory categories using ES6 iterations, compile lowStockItems and flaggedCategories
        ...
        explanation: "Integrates nested dictionary iteration using ES6 Object.entries() and destructuring.",
        testCases: [
          {
            id: 1,
            input: [
            ...
            description: "Correctly groups bananas and milk under the min threshold, flagging both categories"
          },
          {
            id: 2,
            input: [
            ...
            description: "Audits accessory list properly while discarding ample stock items from other categories"
          }
        ]
      },
      {
...
// settings.style.color can still be modified because freeze is shallow`,
  ...
  // Recursively freeze nested children object/array properties, then freeze obj
        ...
        explanation: "Deep freezing ensures absolute immutability, which acts as a foundational principle in state libraries like Redux.",
        testCases: [
          {
            id: 1,
...
// Swap outer dimensions to build cols: [[10], [20]]`,
  ...
  // Map row coordinates into cleanly swapped column lists
        ...
        explanation: "Transposing values handles coordinate translation cleanly when swapping viewport orientations in canvas grids.",
        testCases: [
          {
            id: 1,
            input: [[[[1, 2, 3], [4, 5, 6]]]],
...
// Recursively search nested shapes to strip key "pwd" cleanly`,
  ...
  // Recursively omit matching keys from clones of objects and arrays
        ...
        explanation: "Deep filters let systems clean PII fields recursively before syncing states with client devices.",
        testCases: [
          {
            id: 1,
            input: [{ id: 1, secret: "123", profile: { name: "Bob", secret: "foo" } }, "secret"],
            expected: { id: 1, profile: { name: "Bob" } },
            description: "Recursively deletes specified matching keys from both root and nested layers"
          },
          {
            id: 2,
            input: [[{ secret: "xyz", value: 10 }, { value: 20 }], "secret"],
            expected: [{ value: 10 }, { value: 20 }],
            description: "Handles arrays of nested objects perfectly, deleting targeted keys"
          }
        ]
      }
    ]
  },
  {
    ...
    shortDescription: "Practice basic script tasks like counting words or checking text inputs.",
    longExplanation: "This beginner-friendly section will get you writing complete programs to perform realistic text, array, and data formatting tasks. You will practice cleaning text, counting items in lists, sorting numbers, and filtering elements to build solid scripting intuition.",
...
// count is 4`,
        conceptContext: "Spreading a string converts a series of text characters into an array, which allows functional filters to iterate over individual letters cleanly.",
        description: "Write a function `countCharOccurrence(str, char)` that counts how many times a given single character `char` appears in the string `str`. Your implementation MUST be case-insensitive and should showcase elegant, blockless ES6 arrow function syntax.",
  ...
  // Count specific letters inside input sentences (case-insensitive)
        ...
        explanation: "Employs ES6 string spreading combined with modern array filters to replace traditional imperative loops.",
        testCases: [
          { id: 1, input: ["AbcdA", "a"], expected: 2, description: "Counts case-insensitive characters properly" },
          { id: 2, input: ["hello", "l"], expected: 2, description: "Tracks double repeating letters" },
          { id: 3, input: ["abc", "z"], expected: 0, description: "Handles cases with zero occurrences gracefully" }
        ]
      },
      {
...
// freq is { hi: 2, hey: 1 }`,
  ...
  // Split words by space, strip basic punctuation, and map frequencies
        ...
        explanation: "Translates primitive lists into a hashed frequency lookup table utilizing ES6 reduce aggregators.",
        testCases: [
          { id: 1, input: ["apple banana, apple! BANANA."], expected: { apple: 2, banana: 2 }, description: "Strips punctuation and lowercases words correctly" },
          { id: 2, input: ["hello hello world"], expected: { hello: 2, world: 1 }, description: "Understands simple spaced sentences correctly" }
        ]
      },
      {
...
// topKeys is ["cat"]`,
  ...
  // 3. Return the filtered words array sorted alphabetically
        ...
        explanation: "Integrates dictionary mapping with functional filtering and alphabetical array sorting.",
        testCases: [
          { id: 1, input: ["the dog chased the cat and the dog", 2], expected: ["dog", "the"], description: "Filters words and returns them in perfect alphabetical order" },
          { id: 2, input: ["sweet sour sweet sweet salty", 3], expected: ["sweet"], description: "Extracts single high-frequency exceptions correctly" }
        ]
      },
      {
...
// Alphabetical backup locale compare checks: a.localeCompare(b)`,
  ...
  // Extract top k elements sorted by count descending, then alphabetically on count ties
        ...
        explanation: "Combines frequency mapping with multi-criteria custom sorting formulas used in analytics engines.",
        testCases: [
          { id: 1, input: ["banana apple banana cherry apple banana orange", 2], expected: ["banana", "apple"], description: "Returns top 2 popular items correctly" },
          { id: 2, input: ["b a c b a c", 2], expected: ["a", "b"], description: "Resolves alphabetical tie-breakers beautifully on identical match counts" }
        ]
      },
      {
...
// Select target keyword with highest frequency count using active dictionary indexes`,
  ...
  // Match frequency table results against targeted list search queries
        ...
        explanation: "Demonstrates practical document analyzer matches, intersecting freeform input grids with target reference datasets.",
        testCases: [
          { id: 1, input: ["The quick clever fox jumped over the lazy sleeping fox", ["fox", "lazy", "dog"]], expected: "fox", description: "Selects target word with highest frequency successfully" },
          { id: 2, input: ["hello world", ["cat", "dog"]], expected: null, description: "Returns null when zero target criteria matches are found" },
          { id: 3, input: ["cat dog mouse", ["dog", "cat"]], expected: "dog", description: "Resolves ties in favor of array index priorities inside the targets array" }
        ]
      },
      {
        id: "algo-array-chunk",
...
// firstPage is [10, 20]`,
  ...
  // Split array elements into nested subsets using slice calculations
        ...
        explanation: "Array chunking is a foundational utility used across paginators, batch download managers, and rendering lists.",
        testCases: [
          {
            id: 1,
            input: [[1, 2, 3, 4, 5], 2],
            expected: [[1, 2], [3, 4], [5]],
            description: "Splits five elements into intervals of two, leaving a trailing single item chunk"
          },
          {
            id: 2,
            input: [["a", "b", "c"], 5],
...
// title is "Hello"`,
  ...
  // Convert Str into matching words, capitalise initial index values, and join back with space
        ...
        explanation: "Dynamic string token parsing handles layout transformations in newsfeeds and content management portals.",
        testCases: [
          {
            id: 1,
            input: ["I'm a lItTlE tEaPoT"],
            expected: "I'm A Little Teapot",
            description: "Format title capitalization perfectly with correct casing across scattered alphabets"
          },
          {
            id: 2,
            input: ["sHoRt AnD sToUt"],
            expected: "Short And Stout",
            description: "Takes lowercased or mixed casing string lines and converts them cleanly"
          }
        ]
      },
      {
...
// oddsOnly is [1, 3]`,
  ...
  // Generate sequence elements progressively and accumulate odd value matches
        ...
        explanation: "Iterative sequence filters compute dynamic thresholds in linear O(N) step speeds without triggering Call Stack overflows.",
        testCases: [
          {
            id: 1,
            input: [4],
            expected: 5,
            description: "Calculates sum of odd Fibonacci integers up to 4 correctly: 1 + 1 + 3 = 5"
          },
          {
            id: 2,
            input: [1000],
            expected: 1785,
            description: "Computes total sum of larger odd Fibonacci integers up to 1000 successfully"
          }
        ]
      }
    ]
  },
  {
    ...
    shortDescription: "Solve intermediate problems with schedules, timelines, and overlapping ranges.",
    longExplanation: "Take your skills further by solving intermediate problems. You will work with ranges, manage calendars, find overlapping schedule spots, and learn how to align nested lists and timelines sequentially.",
...
// Detect contiguous breaks (difference !== 1) to cluster ranges`,
        conceptContext: "Iterating elements and tracking value sequence gaps groups continuous segments into tuple arrays.",
        description: "Write a function `findContinuousRanges(nums)` that takes a sorted array of unique integers and groups adjacent sequential numbers together, returning them as a list of interval coordinate tuples `[start, end]`.",
  ...
  // Pack adjacent sequences into interval bounds [start, end]
        ...
        explanation: "Compacts continuous sequences into concise intervals, typical of compression routines.",
        testCases: [
          { id: 1, input: [[1, 2, 3, 5, 6, 8]], expected: [[1, 3], [5, 6], [8, 8]], description: "Packs linear values into three separate compact groups" },
          { id: 2, input: [[10, 11, 12, 13]], expected: [[10, 13]], description: "Squeezes standard continuous spans into a single block" },
          { id: 3, input: [[]], expected: [], description: "Correctly handles empty arrays" }
        ]
      },
      {
...
// Resolve overlap bounds dynamically to return [[1, 4]]`,
  ...
  // Sort by start coordinates, then loop and merge overlapping boundaries
        ...
        explanation: "Standard greedy-scheduler interval merger, consolidating sparse time grids.",
        testCases: [
          { id: 1, input: [[[1, 3], [8, 10], [2, 6], [15, 18]]], expected: [[1, 6], [8, 10], [15, 18]], description: "Merges overlapping intervals and leaves independent bounds untouched" },
          { id: 2, input: [[[1, 4], [4, 5]]], expected: [[1, 5]], description: "Merges intervals with touching boundary numbers together" }
        ]
      },
      {
...
// Insert [2, 7] and reduce output loops to return [[1, 7]]`,
  ...
  // Insert a new event interval into sorted timetables and resolve merge overlaps
        ...
        explanation: "Implements event insertions inside live calendars without breaking disjoint bounds rules.",
        testCases: [
          { id: 1, input: [[[1, 3], [6, 9]], [2, 5]], expected: [[1, 5], [6, 9]], description: "Inserts overlap bounds, joining two segments together" },
          { id: 2, input: [[[1, 2], [3, 5], [6, 7], [8, 10]], [4, 8]], expected: [[1, 2], [3, 10]], description: "Fuses multiple intervals together upon crossing midpoints" }
        ]
      },
      {
...
// Keep intersection ranges: [[3, 5]]`,
        conceptContext: "Scanning two sorted disjoint arrays using pointers measures maximum starts against minimum ends to locate structural intersections.",
        description: "Let's extract overlapping segments between two separate timetables!\n\nWrite a function `findIntervalIntersection(listA, listB)` that takes two separate lists of disjoint, sorted intervals, detects all overlapping ranges, and returns a new array of intersection intervals.",
  ...
  // Traverse both sorted timetables simultaneously and record intersections
        ...
        explanation: "Simultaneous linear scans identifying meeting times across discrete schedules.",
        testCases: [
          { id: 1, input: [[[0, 2], [5, 10]], [[1, 5], [8, 12]]], expected: [[1, 2], [5, 5], [8, 10]], description: "Extracts intersection segments including point intersections" },
          { id: 2, input: [[[1, 10]], [[2, 3], [5, 7]]], expected: [[2, 3], [5, 7]], description: "Identifies multiple intersections occurring inside a broad master interval" }
        ]
      },
      {
...
// Subtract busy limits from total time bounds to locate team availabilities`,
  ...
  // 3. Filter open segments meeting the minDuration requirement
        ...
        explanation: "The ultimate peak of real-world calendar management systems, coordinating multiple schedule streams using interval merging.",
        testCases: [
          { id: 1, input: [[[[12, 13], [14, 15]], [[12, 14]]], [9, 17], 1], expected: [[9, 12], [15, 17]], description: "Coordinates multiple busy calendar timelines and extracts available slots" },
          { id: 2, input: [[[[9, 10]], [[10, 11]]], [9, 12], 1], expected: [[11, 12]], description: "Detects gaps nicely in touching busy grids" }
        ]
      },
      {
...
// Reduce items to compile: { A: 150 }`,
  ...
  // Solve aggregate sums categorized by groupKey using ES6 reduce
        ...
        explanation: "Dynamic group-by tally aggregates process multi-variable records inside a single, highly-optimized linear O(N) pass.",
        testCases: [
          {
            id: 1,
            input: [
            ...
            expected: { A: 15, B: 20 },
            description: "Correctly groups item targets by matching Category keys and sums their corresponding values"
          },
          {
            id: 2,
            input: [
            ...
            description: "Groups departments by expense and computes distinct tallies perfectly"
          }
        ]
      }
    ]
